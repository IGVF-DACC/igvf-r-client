...
test_that("base_modifications", {
  # tests for the property `base_modifications` (set[character])
...
test_that("external_image_data_url", {
  # tests for the property `external_image_data_url` (character)
  # Links to the external site where images and related data produced by this analysis are stored.

  # uncomment below to test the property
  #expect_equal(model.instance$`external_image_data_url`, "EXPECTED_RESULT")
})
...
test_that("genes", {
  # tests for the property `genes` (set[character])
