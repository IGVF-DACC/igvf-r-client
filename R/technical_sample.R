  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`construct_delivery_methods`)) {
        TechnicalSampleObject[["construct_delivery_methods"]] <-
