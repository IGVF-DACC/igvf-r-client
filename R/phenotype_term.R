  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`preview_timestamp`)) {
        PhenotypeTermObject[["preview_timestamp"]] <-
      ...
      if (!is.null(self$`definition`)) {
        PhenotypeTermObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`comments`)) {
        PhenotypeTermObject[["comments"]] <-
          self$`comments`
      }
    ...
    isValid = function() {
      ...
      if (!str_detect(self$`term_id`, "^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$")) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      if (!str_detect(self$`term_id`, "^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$")) {
        invalid_fields["term_id"] <- "Invalid value for `term_id`, must conform to the pattern ^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$."
      }
