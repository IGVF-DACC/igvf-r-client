  ...
  public = list(
    ...
    initialize = function(`anvil_url` = NULL, `catalog_collections` = NULL, `catalog_class` = NULL, `catalog_notes` = NULL, `preview_timestamp` = NULL, `release_timestamp` = NULL, `reference_files` = NULL, `filtered` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `derived_manually` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `checkfiles_version` = NULL, `checkfiles_timestamp` = NULL, `supersedes` = NULL, `strand_specificity` = NULL, `normalized` = NULL, `start_view_position` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `quality_metrics` = NULL, `superseded_by` = NULL, `assay_titles` = NULL, `preferred_assay_titles` = NULL, `preferred_assay_slims` = NULL, `workflows` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, `content_summary` = NULL, `transcriptome_annotation` = NULL, `assembly` = NULL, ...) {
      ...
      if (!is.null(`file_format`)) {
        if (!(`file_format` %in% c("bigWig", "npz", "tar"))) {
          stop(paste("Error! \"", `file_format`, "\" cannot be assigned to `file_format`. Must be \"bigWig\", \"npz\", \"tar\".", sep = ""))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`catalog_class`)) {
        SignalFileObject[["catalog_class"]] <-
          self$`catalog_class`
      }
      if (!is.null(self$`catalog_notes`)) {
        SignalFileObject[["catalog_notes"]] <-
          self$`catalog_notes`
      }
      ...
      if (!is.null(self$`checkfiles_timestamp`)) {
        SignalFileObject[["checkfiles_timestamp"]] <-
          self$`checkfiles_timestamp`
      }
      if (!is.null(self$`supersedes`)) {
        SignalFileObject[["supersedes"]] <-
          self$`supersedes`
      }
      ...
      if (!is.null(self$`superseded_by`)) {
        SignalFileObject[["superseded_by"]] <-
          self$`superseded_by`
      }
      ...
      if (!is.null(self$`preferred_assay_slims`)) {
        SignalFileObject[["preferred_assay_slims"]] <-
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_format`)) {
        if (!is.null(this_object$`file_format`) && !(this_object$`file_format` %in% c("bigWig", "npz", "tar"))) {
          stop(paste("Error! \"", this_object$`file_format`, "\" cannot be assigned to `file_format`. Must be \"bigWig\", \"npz\", \"tar\".", sep = ""))
        }
