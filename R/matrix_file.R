  ...
  public = list(
    ...
    initialize = function(`anvil_url` = NULL, `catalog_collections` = NULL, `catalog_class` = NULL, `catalog_notes` = NULL, `preview_timestamp` = NULL, `release_timestamp` = NULL, `reference_files` = NULL, `filtered` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `derived_manually` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `checkfiles_version` = NULL, `supersedes` = NULL, `principal_dimension` = NULL, `secondary_dimensions` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `quality_metrics` = NULL, `superseded_by` = NULL, `assay_titles` = NULL, `preferred_assay_titles` = NULL, `workflows` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, `content_summary` = NULL, `transcriptome_annotation` = NULL, `assembly` = NULL, ...) {
      ...
      if (!is.null(`file_format`)) {
        if (!(`file_format` %in% c("h5ad", "h5mu", "hdf5", "mtx", "pkl", "rds", "Robj", "tar", "hic", "cool", "mcool"))) {
          stop(paste("Error! \"", `file_format`, "\" cannot be assigned to `file_format`. Must be \"h5ad\", \"h5mu\", \"hdf5\", \"mtx\", \"pkl\", \"rds\", \"Robj\", \"tar\", \"hic\", \"cool\", \"mcool\".", sep = ""))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`anvil_url`)) {
        MatrixFileObject[["anvil_url"]] <-
          self$`anvil_url`
      }
      if (!is.null(self$`catalog_collections`)) {
        MatrixFileObject[["catalog_collections"]] <-
          self$`catalog_collections`
      }
      if (!is.null(self$`catalog_class`)) {
        MatrixFileObject[["catalog_class"]] <-
          self$`catalog_class`
      }
      if (!is.null(self$`catalog_notes`)) {
        MatrixFileObject[["catalog_notes"]] <-
          self$`catalog_notes`
      }
      if (!is.null(self$`preview_timestamp`)) {
        MatrixFileObject[["preview_timestamp"]] <-
      ...
      if (!is.null(self$`derived_manually`)) {
        MatrixFileObject[["derived_manually"]] <-
      ...
      if (!is.null(self$`checkfiles_version`)) {
        MatrixFileObject[["checkfiles_version"]] <-
      ...
      if (!is.null(self$`quality_metrics`)) {
        MatrixFileObject[["quality_metrics"]] <-
          self$`quality_metrics`
      }
      if (!is.null(self$`superseded_by`)) {
        MatrixFileObject[["superseded_by"]] <-
          self$`superseded_by`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_format`)) {
        if (!is.null(this_object$`file_format`) && !(this_object$`file_format` %in% c("h5ad", "h5mu", "hdf5", "mtx", "pkl", "rds", "Robj", "tar", "hic", "cool", "mcool"))) {
          stop(paste("Error! \"", this_object$`file_format`, "\" cannot be assigned to `file_format`. Must be \"h5ad\", \"h5mu\", \"hdf5\", \"mtx\", \"pkl\", \"rds\", \"Robj\", \"tar\", \"hic\", \"cool\", \"mcool\".", sep = ""))
        }
