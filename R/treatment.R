...
#' @field purpose The intended purpose for treating the samples. character [optional]
...
#' @field treatment_type The classification of treatment agent that specifies its exact molecular nature. character [optional]
...
Treatment <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param treatment_type The classification of treatment agent that specifies its exact molecular nature.
    ...
    initialize = function(`preview_timestamp` = NULL, `release_timestamp` = NULL, `lab` = NULL, `award` = NULL, `sources` = NULL, `lot_id` = NULL, `product_id` = NULL, `documents` = NULL, `status` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `amount` = NULL, `amount_units` = NULL, `duration` = NULL, `duration_units` = NULL, `pH` = NULL, `purpose` = NULL, `post_treatment_time` = NULL, `post_treatment_time_units` = NULL, `temperature` = NULL, `temperature_units` = NULL, `treatment_type` = NULL, `treatment_term_id` = NULL, `treatment_term_name` = NULL, `depletion` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `biosamples_treated` = NULL, ...) {
      ...
      if (!is.null(`purpose`)) {
        if (!(`purpose` %in% c("activation", "acute stimulation", "agonist", "antagonist", "chronic stimulation", "control", "de-differentiation", "differentiation", "perturbation", "selection", "stimulation"))) {
          stop(paste("Error! \"", `purpose`, "\" cannot be assigned to `purpose`. Must be \"activation\", \"acute stimulation\", \"agonist\", \"antagonist\", \"chronic stimulation\", \"control\", \"de-differentiation\", \"differentiation\", \"perturbation\", \"selection\", \"stimulation\".", sep = ""))
        }
      ...
      if (!is.null(`treatment_type`)) {
        if (!(`treatment_type` %in% c("chemical", "protein", "diet"))) {
          stop(paste("Error! \"", `treatment_type`, "\" cannot be assigned to `treatment_type`. Must be \"chemical\", \"protein\", \"diet\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`purpose`)) {
        if (!is.null(this_object$`purpose`) && !(this_object$`purpose` %in% c("activation", "acute stimulation", "agonist", "antagonist", "chronic stimulation", "control", "de-differentiation", "differentiation", "perturbation", "selection", "stimulation"))) {
          stop(paste("Error! \"", this_object$`purpose`, "\" cannot be assigned to `purpose`. Must be \"activation\", \"acute stimulation\", \"agonist\", \"antagonist\", \"chronic stimulation\", \"control\", \"de-differentiation\", \"differentiation\", \"perturbation\", \"selection\", \"stimulation\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`treatment_type`)) {
        if (!is.null(this_object$`treatment_type`) && !(this_object$`treatment_type` %in% c("chemical", "protein", "diet"))) {
          stop(paste("Error! \"", this_object$`treatment_type`, "\" cannot be assigned to `treatment_type`. Must be \"chemical\", \"protein\", \"diet\".", sep = ""))
        }
