...
#' @field crispr_screen_readout For auxiliary sets linked to CRISPR screen measurement sets, equivalent to file set type. character [optional]
...
AuxiliarySet <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param crispr_screen_readout For auxiliary sets linked to CRISPR screen measurement sets, equivalent to file set type.
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`crispr_screen_readout`)) {
        AuxiliarySetObject[["crispr_screen_readout"]] <-
