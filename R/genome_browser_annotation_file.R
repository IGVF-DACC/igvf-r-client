  ...
  public = list(
    ...
    initialize = function(`preview_timestamp` = NULL, `cell_type_annotation` = NULL, `assembly` = NULL, `release_timestamp` = NULL, `file_format_type` = NULL, `transcriptome_annotation` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `derived_manually` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `checkfiles_version` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `quality_metrics` = NULL, `assay_titles` = NULL, `workflow` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, ...) {
      ...
      if (!is.null(`file_format`)) {
        if (!(`file_format` %in% c("bigBed"))) {
          stop(paste("Error! \"", `file_format`, "\" cannot be assigned to `file_format`. Must be \"bigBed\".", sep = ""))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`preview_timestamp`)) {
        GenomeBrowserAnnotationFileObject[["preview_timestamp"]] <-
      ...
      if (!is.null(self$`checkfiles_version`)) {
        GenomeBrowserAnnotationFileObject[["checkfiles_version"]] <-
      ...
      if (!is.null(self$`quality_metrics`)) {
        GenomeBrowserAnnotationFileObject[["quality_metrics"]] <-
      ...
      if (!is.null(self$`workflow`)) {
        GenomeBrowserAnnotationFileObject[["workflow"]] <-
          self$`workflow`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_format`)) {
        if (!is.null(this_object$`file_format`) && !(this_object$`file_format` %in% c("bigBed"))) {
          stop(paste("Error! \"", this_object$`file_format`, "\" cannot be assigned to `file_format`. Must be \"bigBed\".", sep = ""))
        }
