...
WholeOrganism <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`is_on_anvil` = NULL, `preview_timestamp` = NULL, `release_timestamp` = NULL, `taxa` = NULL, `publications` = NULL, `url` = NULL, `sources` = NULL, `lot_id` = NULL, `product_id` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `annotated_from` = NULL, `lower_bound_age` = NULL, `upper_bound_age` = NULL, `age_units` = NULL, `sample_terms` = NULL, `disease_terms` = NULL, `pooled_from` = NULL, `originated_from` = NULL, `treatments` = NULL, `donors` = NULL, `biomarkers` = NULL, `embryonic` = NULL, `modifications` = NULL, `cellular_sub_pool` = NULL, `phenotypic_features` = NULL, `starting_amount` = NULL, `starting_amount_units` = NULL, `dbxrefs` = NULL, `date_obtained` = NULL, `part_of` = NULL, `sorted_from` = NULL, `sorted_from_detail` = NULL, `virtual` = NULL, `construct_library_sets` = NULL, `moi` = NULL, `nucleic_acid_delivery` = NULL, `time_post_library_delivery` = NULL, `time_post_library_delivery_units` = NULL, `protocols` = NULL, `supersedes` = NULL, `selection_conditions` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `file_sets` = NULL, `multiplexed_in` = NULL, `parts` = NULL, `sorted_fractions` = NULL, `origin_of` = NULL, `institutional_certificates` = NULL, `superseded_by` = NULL, `sex` = NULL, `age` = NULL, `upper_bound_age_in_hours` = NULL, `lower_bound_age_in_hours` = NULL, `pooled_in` = NULL, `classifications` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return WholeOrganism in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`taxa`)) {
        WholeOrganismObject[["taxa"]] <-
          self$`taxa`
      }
      if (!is.null(self$`publications`)) {
        WholeOrganismObject[["publications"]] <-
          self$`publications`
      }
      if (!is.null(self$`url`)) {
        WholeOrganismObject[["url"]] <-
          self$`url`
      }
      if (!is.null(self$`sources`)) {
        WholeOrganismObject[["sources"]] <-
          self$`sources`
      }
      if (!is.null(self$`lot_id`)) {
        WholeOrganismObject[["lot_id"]] <-
          self$`lot_id`
      }
      if (!is.null(self$`product_id`)) {
        WholeOrganismObject[["product_id"]] <-
          self$`product_id`
      }
      if (!is.null(self$`documents`)) {
        WholeOrganismObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        WholeOrganismObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        WholeOrganismObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        WholeOrganismObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        WholeOrganismObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        WholeOrganismObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        WholeOrganismObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        WholeOrganismObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        WholeOrganismObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        WholeOrganismObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        WholeOrganismObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        WholeOrganismObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        WholeOrganismObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        WholeOrganismObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        WholeOrganismObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        WholeOrganismObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`annotated_from`)) {
        WholeOrganismObject[["annotated_from"]] <-
          self$`annotated_from`
      }
      if (!is.null(self$`lower_bound_age`)) {
        WholeOrganismObject[["lower_bound_age"]] <-
          self$`lower_bound_age`
      }
      if (!is.null(self$`upper_bound_age`)) {
        WholeOrganismObject[["upper_bound_age"]] <-
          self$`upper_bound_age`
      }
      if (!is.null(self$`age_units`)) {
        WholeOrganismObject[["age_units"]] <-
          self$`age_units`
      }
      if (!is.null(self$`sample_terms`)) {
        WholeOrganismObject[["sample_terms"]] <-
          self$`sample_terms`
      }
      if (!is.null(self$`disease_terms`)) {
        WholeOrganismObject[["disease_terms"]] <-
          self$`disease_terms`
      }
      if (!is.null(self$`pooled_from`)) {
        WholeOrganismObject[["pooled_from"]] <-
          self$`pooled_from`
      }
      if (!is.null(self$`originated_from`)) {
        WholeOrganismObject[["originated_from"]] <-
          self$`originated_from`
      }
      if (!is.null(self$`treatments`)) {
        WholeOrganismObject[["treatments"]] <-
          self$`treatments`
      }
      if (!is.null(self$`donors`)) {
        WholeOrganismObject[["donors"]] <-
          self$`donors`
      }
      if (!is.null(self$`biomarkers`)) {
        WholeOrganismObject[["biomarkers"]] <-
          self$`biomarkers`
      }
      if (!is.null(self$`embryonic`)) {
        WholeOrganismObject[["embryonic"]] <-
          self$`embryonic`
      }
      if (!is.null(self$`modifications`)) {
        WholeOrganismObject[["modifications"]] <-
          self$`modifications`
      }
      if (!is.null(self$`cellular_sub_pool`)) {
        WholeOrganismObject[["cellular_sub_pool"]] <-
          self$`cellular_sub_pool`
      }
      if (!is.null(self$`phenotypic_features`)) {
        WholeOrganismObject[["phenotypic_features"]] <-
          self$`phenotypic_features`
      }
      if (!is.null(self$`starting_amount`)) {
        WholeOrganismObject[["starting_amount"]] <-
          self$`starting_amount`
      }
      if (!is.null(self$`starting_amount_units`)) {
        WholeOrganismObject[["starting_amount_units"]] <-
          self$`starting_amount_units`
      }
      if (!is.null(self$`dbxrefs`)) {
        WholeOrganismObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      if (!is.null(self$`date_obtained`)) {
        WholeOrganismObject[["date_obtained"]] <-
          self$`date_obtained`
      }
      if (!is.null(self$`part_of`)) {
        WholeOrganismObject[["part_of"]] <-
          self$`part_of`
      }
      if (!is.null(self$`sorted_from`)) {
        WholeOrganismObject[["sorted_from"]] <-
          self$`sorted_from`
      }
      if (!is.null(self$`sorted_from_detail`)) {
        WholeOrganismObject[["sorted_from_detail"]] <-
          self$`sorted_from_detail`
      }
      if (!is.null(self$`virtual`)) {
        WholeOrganismObject[["virtual"]] <-
          self$`virtual`
      }
      if (!is.null(self$`construct_library_sets`)) {
        WholeOrganismObject[["construct_library_sets"]] <-
          self$`construct_library_sets`
      }
      if (!is.null(self$`moi`)) {
        WholeOrganismObject[["moi"]] <-
          self$`moi`
      }
      if (!is.null(self$`nucleic_acid_delivery`)) {
        WholeOrganismObject[["nucleic_acid_delivery"]] <-
          self$`nucleic_acid_delivery`
      }
      if (!is.null(self$`time_post_library_delivery`)) {
        WholeOrganismObject[["time_post_library_delivery"]] <-
          self$`time_post_library_delivery`
      }
      if (!is.null(self$`time_post_library_delivery_units`)) {
        WholeOrganismObject[["time_post_library_delivery_units"]] <-
      ...
      if (!is.null(self$`selection_conditions`)) {
        WholeOrganismObject[["selection_conditions"]] <-
      ...
      if (!is.null(self$`@type`)) {
        WholeOrganismObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        WholeOrganismObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`file_sets`)) {
        WholeOrganismObject[["file_sets"]] <-
          self$`file_sets`
      }
      if (!is.null(self$`multiplexed_in`)) {
        WholeOrganismObject[["multiplexed_in"]] <-
          self$`multiplexed_in`
      }
      if (!is.null(self$`parts`)) {
        WholeOrganismObject[["parts"]] <-
          self$`parts`
      }
      if (!is.null(self$`sorted_fractions`)) {
        WholeOrganismObject[["sorted_fractions"]] <-
          self$`sorted_fractions`
      }
      if (!is.null(self$`origin_of`)) {
        WholeOrganismObject[["origin_of"]] <-
          self$`origin_of`
      }
    ...
    #' @return the instance of WholeOrganism
    #' @export
    ...
    #' Validate JSON input with respect to WholeOrganism
    #'
    #' @description
    #' Validate JSON input with respect to WholeOrganism and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WholeOrganism
    #' @export
    toString = function() {
      self$toJSONString()
    },
