  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`checkfiles_timestamp`)) {
        SequenceFileObject[["checkfiles_timestamp"]] <-
      ...
      if (!is.null(self$`preferred_assay_slims`)) {
        SequenceFileObject[["preferred_assay_slims"]] <-
