  ...
  public = list(
    ...
    initialize = function(`preview_timestamp` = NULL, `release_timestamp` = NULL, `taxa` = NULL, `publications` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `url` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `dbxrefs` = NULL, `samples` = NULL, `donors` = NULL, `file_set_type` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `files` = NULL, `control_for` = NULL, `submitted_files_timestamp` = NULL, `input_for` = NULL, `construct_library_sets` = NULL, `data_use_limitation_summaries` = NULL, `controlled_access` = NULL, `assemblies` = NULL, `transcriptome_annotations` = NULL, ...) {
      ...
      if (!is.null(`file_set_type`)) {
        if (!(`file_set_type` %in% c("barcodes", "editing templates", "elements", "external data for catalog", "genome", "genes", "guide RNAs", "pipeline parameters", "primer design", "training data for predictive models", "transcriptome", "variants"))) {
          stop(paste("Error! \"", `file_set_type`, "\" cannot be assigned to `file_set_type`. Must be \"barcodes\", \"editing templates\", \"elements\", \"external data for catalog\", \"genome\", \"genes\", \"guide RNAs\", \"pipeline parameters\", \"primer design\", \"training data for predictive models\", \"transcriptome\", \"variants\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_set_type`)) {
        if (!is.null(this_object$`file_set_type`) && !(this_object$`file_set_type` %in% c("barcodes", "editing templates", "elements", "external data for catalog", "genome", "genes", "guide RNAs", "pipeline parameters", "primer design", "training data for predictive models", "transcriptome", "variants"))) {
          stop(paste("Error! \"", this_object$`file_set_type`, "\" cannot be assigned to `file_set_type`. Must be \"barcodes\", \"editing templates\", \"elements\", \"external data for catalog\", \"genome\", \"genes\", \"guide RNAs\", \"pipeline parameters\", \"primer design\", \"training data for predictive models\", \"transcriptome\", \"variants\".", sep = ""))
        }
