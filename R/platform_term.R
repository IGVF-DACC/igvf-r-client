...
PlatformTerm <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`release_timestamp` = NULL, `status` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `term_id` = NULL, `term_name` = NULL, `deprecated_ntr_terms` = NULL, `is_a` = NULL, `company` = NULL, `sequencing_kits` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `name` = NULL, `synonyms` = NULL, `ancestors` = NULL, `ontology` = NULL, ...) {
      ...
      if (!is.null(`company`)) {
        if (!(`company` %in% c("10X Genomics", "Illumina", "Life Technologies", "Oxford Nanopore Technologies", "Pacific Biosciences", "Parse Biosciences", "Roche", "Singular Genomics"))) {
          stop(paste("Error! \"", `company`, "\" cannot be assigned to `company`. Must be \"10X Genomics\", \"Illumina\", \"Life Technologies\", \"Oxford Nanopore Technologies\", \"Pacific Biosciences\", \"Parse Biosciences\", \"Roche\", \"Singular Genomics\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`company`)) {
        if (!is.null(this_object$`company`) && !(this_object$`company` %in% c("10X Genomics", "Illumina", "Life Technologies", "Oxford Nanopore Technologies", "Pacific Biosciences", "Parse Biosciences", "Roche", "Singular Genomics"))) {
          stop(paste("Error! \"", this_object$`company`, "\" cannot be assigned to `company`. Must be \"10X Genomics\", \"Illumina\", \"Life Technologies\", \"Oxford Nanopore Technologies\", \"Pacific Biosciences\", \"Parse Biosciences\", \"Roche\", \"Singular Genomics\".", sep = ""))
        }
