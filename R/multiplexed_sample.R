#' Create a new MultiplexedSample
#'
#' @description
  ...
  public = list(
    ...
    initialize = function(`is_on_anvil` = NULL, `preview_timestamp` = NULL, `release_timestamp` = NULL, `publications` = NULL, `url` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `starting_amount` = NULL, `starting_amount_units` = NULL, `dbxrefs` = NULL, `date_obtained` = NULL, `part_of` = NULL, `sorted_from` = NULL, `sorted_from_detail` = NULL, `virtual` = NULL, `construct_library_sets` = NULL, `moi` = NULL, `construct_delivery_methods` = NULL, `time_post_library_delivery` = NULL, `time_post_library_delivery_units` = NULL, `protocols` = NULL, `supersedes` = NULL, `selection_conditions` = NULL, `multiplexed_samples` = NULL, `multiplexing_methods` = NULL, `cellular_sub_pool` = NULL, `barcode_map` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `file_sets` = NULL, `multiplexed_in` = NULL, `parts` = NULL, `sorted_fractions` = NULL, `origin_of` = NULL, `institutional_certificates` = NULL, `superseded_by` = NULL, `demultiplexed_to` = NULL, `sample_terms` = NULL, `taxa` = NULL, `phenotypic_features` = NULL, `treatments` = NULL, `modifications` = NULL, `donors` = NULL, `biomarkers` = NULL, `sources` = NULL, `classifications` = NULL, `targeted_sample_terms` = NULL, ...) {
      ...
      if (!is.null(`multiplexed_samples`)) {
        ...
        self$`multiplexed_samples` <- `multiplexed_samples`
      }
      if (!is.null(`multiplexing_methods`)) {
        stopifnot(is.vector(`multiplexing_methods`), length(`multiplexing_methods`) != 0)
        sapply(`multiplexing_methods`, function(x) stopifnot(is.character(x)))
        self$`multiplexing_methods` <- `multiplexing_methods`
      }
    ...
    #' To JSON String
    #'
    #' @return MultiplexedSample in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`release_timestamp`)) {
        MultiplexedSampleObject[["release_timestamp"]] <-
          self$`release_timestamp`
      }
      if (!is.null(self$`publications`)) {
        MultiplexedSampleObject[["publications"]] <-
          self$`publications`
      }
      if (!is.null(self$`url`)) {
        MultiplexedSampleObject[["url"]] <-
          self$`url`
      }
      if (!is.null(self$`documents`)) {
        MultiplexedSampleObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        MultiplexedSampleObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        MultiplexedSampleObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        MultiplexedSampleObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        MultiplexedSampleObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        MultiplexedSampleObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        MultiplexedSampleObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        MultiplexedSampleObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        MultiplexedSampleObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        MultiplexedSampleObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        MultiplexedSampleObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        MultiplexedSampleObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        MultiplexedSampleObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        MultiplexedSampleObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        MultiplexedSampleObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        MultiplexedSampleObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`starting_amount`)) {
        MultiplexedSampleObject[["starting_amount"]] <-
          self$`starting_amount`
      }
      if (!is.null(self$`starting_amount_units`)) {
        MultiplexedSampleObject[["starting_amount_units"]] <-
          self$`starting_amount_units`
      }
      if (!is.null(self$`dbxrefs`)) {
        MultiplexedSampleObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      ...
      if (!is.null(self$`sorted_from_detail`)) {
        MultiplexedSampleObject[["sorted_from_detail"]] <-
          self$`sorted_from_detail`
      }
      if (!is.null(self$`virtual`)) {
        MultiplexedSampleObject[["virtual"]] <-
          self$`virtual`
      }
      if (!is.null(self$`construct_library_sets`)) {
        MultiplexedSampleObject[["construct_library_sets"]] <-
      ...
      if (!is.null(self$`time_post_library_delivery_units`)) {
        MultiplexedSampleObject[["time_post_library_delivery_units"]] <-
      ...
      if (!is.null(self$`selection_conditions`)) {
        MultiplexedSampleObject[["selection_conditions"]] <-
      ...
      if (!is.null(self$`multiplexing_methods`)) {
        MultiplexedSampleObject[["multiplexing_methods"]] <-
          self$`multiplexing_methods`
      }
      if (!is.null(self$`cellular_sub_pool`)) {
        MultiplexedSampleObject[["cellular_sub_pool"]] <-
          self$`cellular_sub_pool`
      }
      if (!is.null(self$`barcode_map`)) {
        MultiplexedSampleObject[["barcode_map"]] <-
          self$`barcode_map`
      }
      if (!is.null(self$`@id`)) {
        MultiplexedSampleObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        MultiplexedSampleObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        MultiplexedSampleObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`file_sets`)) {
        MultiplexedSampleObject[["file_sets"]] <-
          self$`file_sets`
      }
      ...
      if (!is.null(self$`origin_of`)) {
        MultiplexedSampleObject[["origin_of"]] <-
          self$`origin_of`
      }
      ...
      if (!is.null(self$`modifications`)) {
        MultiplexedSampleObject[["modifications"]] <-
          self$`modifications`
      }
      if (!is.null(self$`donors`)) {
        MultiplexedSampleObject[["donors"]] <-
          self$`donors`
      }
      if (!is.null(self$`biomarkers`)) {
        MultiplexedSampleObject[["biomarkers"]] <-
          self$`biomarkers`
      }
      if (!is.null(self$`sources`)) {
        MultiplexedSampleObject[["sources"]] <-
          self$`sources`
      }
    ...
    #' @return the instance of MultiplexedSample
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`multiplexing_methods`)) {
      ...
      jsoncontent <- c(
        ...
        if (!is.null(self$`multiplexed_samples`)) {
          ...
          '"multiplexed_samples":
             [%s]
          ',
          paste(unlist(lapply(self$`multiplexed_samples`, function(x) paste0('"', x, '"'))), collapse = ",")
          )
        },
        if (!is.null(self$`multiplexing_methods`)) {
          sprintf(
          '"multiplexing_methods":
             [%s]
          ',
          paste(unlist(lapply(self$`multiplexing_methods`, function(x) paste0('"', x, '"'))), collapse = ",")
          )
        },
        if (!is.null(self$`cellular_sub_pool`)) {
          sprintf(
    ...
    #'
    #' @description
    #' Validate JSON input with respect to MultiplexedSample and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of MultiplexedSample
    #' @export
    toString = function() {
      self$toJSONString()
    },
