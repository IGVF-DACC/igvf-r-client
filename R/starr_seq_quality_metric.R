#' Create a new StarrSeqQualityMetric
#'
#' @description
...
#' @field coverage Coverage of the library. numeric [optional]
#' @field coverage_per_basepair Coverage at basepair level. numeric [optional]
#' @field rna_correlation_in_peaks Correlation of RNA only over regions called as peaks in DNA. numeric [optional]
...
#' @export
StarrSeqQualityMetric <- R6::R6Class(
  ...
  public = list(
    ...
    `coverage` = NULL,
    `coverage_per_basepair` = NULL,
    `rna_correlation_in_peaks` = NULL,
    `@id` = NULL,
    `@type` = NULL,
    `summary` = NULL,
    ...
    #' @param coverage Coverage of the library.
    #' @param coverage_per_basepair Coverage at basepair level.
    #' @param rna_correlation_in_peaks Correlation of RNA only over regions called as peaks in DNA.
    #' @param @id @id
    #' @param @type @type
    ...
    initialize = function(`preview_timestamp` = NULL, `status` = NULL, `release_timestamp` = NULL, `attachment` = NULL, `lab` = NULL, `award` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `quality_metric_of` = NULL, `analysis_step_version` = NULL, `coverage` = NULL, `coverage_per_basepair` = NULL, `rna_correlation_in_peaks` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, additional_properties = NULL, ...) {
      ...
      if (!is.null(`coverage_per_basepair`)) {
        self$`coverage_per_basepair` <- `coverage_per_basepair`
      }
      if (!is.null(`rna_correlation_in_peaks`)) {
        self$`rna_correlation_in_peaks` <- `rna_correlation_in_peaks`
      }
      if (!is.null(`@id`)) {
    ...
    #' To JSON String
    #'
    #' @return StarrSeqQualityMetric in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`release_timestamp`)) {
        StarrSeqQualityMetricObject[["release_timestamp"]] <-
          self$`release_timestamp`
      }
      if (!is.null(self$`attachment`)) {
        StarrSeqQualityMetricObject[["attachment"]] <-
          self$`attachment`$toJSON()
      }
      if (!is.null(self$`lab`)) {
        StarrSeqQualityMetricObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        StarrSeqQualityMetricObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`schema_version`)) {
        StarrSeqQualityMetricObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        StarrSeqQualityMetricObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        StarrSeqQualityMetricObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        StarrSeqQualityMetricObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        StarrSeqQualityMetricObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        StarrSeqQualityMetricObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        StarrSeqQualityMetricObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        StarrSeqQualityMetricObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`quality_metric_of`)) {
        StarrSeqQualityMetricObject[["quality_metric_of"]] <-
          self$`quality_metric_of`
      }
      if (!is.null(self$`analysis_step_version`)) {
        StarrSeqQualityMetricObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`coverage`)) {
        StarrSeqQualityMetricObject[["coverage"]] <-
          self$`coverage`
      }
      if (!is.null(self$`coverage_per_basepair`)) {
        StarrSeqQualityMetricObject[["coverage_per_basepair"]] <-
          self$`coverage_per_basepair`
      }
      if (!is.null(self$`rna_correlation_in_peaks`)) {
        StarrSeqQualityMetricObject[["rna_correlation_in_peaks"]] <-
          self$`rna_correlation_in_peaks`
      }
      if (!is.null(self$`@id`)) {
        StarrSeqQualityMetricObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        StarrSeqQualityMetricObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        StarrSeqQualityMetricObject[["summary"]] <-
          self$`summary`
      }
      for (key in names(self$additional_properties)) {
        StarrSeqQualityMetricObject[[key]] <- self$additional_properties[[key]]
      }

      StarrSeqQualityMetricObject
    },
    #' Deserialize JSON string into an instance of StarrSeqQualityMetric
    #'
    #' @description
    #' Deserialize JSON string into an instance of StarrSeqQualityMetric
    #'
    #' @param input_json the JSON input
    #' @return the instance of StarrSeqQualityMetric
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`coverage_per_basepair`)) {
        self$`coverage_per_basepair` <- this_object$`coverage_per_basepair`
      }
      if (!is.null(this_object$`rna_correlation_in_peaks`)) {
        self$`rna_correlation_in_peaks` <- this_object$`rna_correlation_in_peaks`
      }
    ...
    #' Validate JSON input with respect to StarrSeqQualityMetric
    #'
    #' @description
    #' Validate JSON input with respect to StarrSeqQualityMetric and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of StarrSeqQualityMetric
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# StarrSeqQualityMetric$unlock()
#
## Below is an example to define the print function
# StarrSeqQualityMetric$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# StarrSeqQualityMetric$lock()
