#' Create a new ATACFragmentsAlignmentStats
#'
#' @description
#' 
#'
#' @docType class
#' @title ATACFragmentsAlignmentStats
#' @description ATACFragmentsAlignmentStats Class
...
#' @export
ATACFragmentsAlignmentStats <- R6::R6Class(
  ...
  public = list(
    ...
    `width` = NULL,
    `height` = NULL,
    #' Initialize a new ATACFragmentsAlignmentStats class.
    #'
    #' @description
    #' Initialize a new ATACFragmentsAlignmentStats class.
    #'
    ...
    initialize = function(`download` = NULL, `href` = NULL, `type` = NULL, `size` = NULL, `md5sum` = NULL, `width` = NULL, `height` = NULL, ...) {
      ...
      if (!is.null(`type`)) {
        if (!(`type` %in% c("text/plain"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"text/plain\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return ATACFragmentsAlignmentStats in JSON format
    #' @export
    toJSON = function() {
      ATACFragmentsAlignmentStatsObject <- list()
      if (!is.null(self$`download`)) {
        ATACFragmentsAlignmentStatsObject[["download"]] <-
          self$`download`
      }
      if (!is.null(self$`href`)) {
        ATACFragmentsAlignmentStatsObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`type`)) {
        ATACFragmentsAlignmentStatsObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`size`)) {
        ATACFragmentsAlignmentStatsObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`md5sum`)) {
        ATACFragmentsAlignmentStatsObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`width`)) {
        ATACFragmentsAlignmentStatsObject[["width"]] <-
          self$`width`
      }
      if (!is.null(self$`height`)) {
        ATACFragmentsAlignmentStatsObject[["height"]] <-
          self$`height`
      }
      ATACFragmentsAlignmentStatsObject
    },
    #' Deserialize JSON string into an instance of ATACFragmentsAlignmentStats
    #'
    #' @description
    #' Deserialize JSON string into an instance of ATACFragmentsAlignmentStats
    #'
    #' @param input_json the JSON input
    #' @return the instance of ATACFragmentsAlignmentStats
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("text/plain"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"text/plain\".", sep = ""))
        }
    ...
    #' Validate JSON input with respect to ATACFragmentsAlignmentStats
    #'
    #' @description
    #' Validate JSON input with respect to ATACFragmentsAlignmentStats and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ATACFragmentsAlignmentStats
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ATACFragmentsAlignmentStats$unlock()
#
## Below is an example to define the print function
# ATACFragmentsAlignmentStats$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ATACFragmentsAlignmentStats$lock()
