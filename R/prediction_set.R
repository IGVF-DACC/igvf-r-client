  ...
  public = list(
    ...
    initialize = function(`cell_type` = NULL, `cell_qualifier` = NULL, `is_on_anvil` = NULL, `doi` = NULL, `preview_timestamp` = NULL, `input_file_sets` = NULL, `small_scale_loci_list` = NULL, `large_scale_loci_list` = NULL, `small_scale_gene_list` = NULL, `large_scale_gene_list` = NULL, `release_timestamp` = NULL, `publications` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `url` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `dbxrefs` = NULL, `samples` = NULL, `donors` = NULL, `file_set_type` = NULL, `supersedes` = NULL, `scope` = NULL, `assessed_genes` = NULL, `associated_phenotypes` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `files` = NULL, `control_for` = NULL, `superseded_by` = NULL, `submitted_files_timestamp` = NULL, `input_for` = NULL, `construct_library_sets` = NULL, `data_use_limitation_summaries` = NULL, `controlled_access` = NULL, `software_versions` = NULL, `cell_annotation` = NULL, additional_properties = NULL, ...) {
      ...
      if (!is.null(`file_set_type`)) {
        if (!(`file_set_type` %in% c("chromatin accessibility", "coding variant effects", "coding variant effects on PPI", "coding variants pathogenicity", "disease associations", "element-gene links", "gene regulatory networks", "genetic constraint", "meta analysis", "non-coding variant effects", "spatial gene expression variability", "TF binding", "variant TF binding effects"))) {
          stop(paste("Error! \"", `file_set_type`, "\" cannot be assigned to `file_set_type`. Must be \"chromatin accessibility\", \"coding variant effects\", \"coding variant effects on PPI\", \"coding variants pathogenicity\", \"disease associations\", \"element-gene links\", \"gene regulatory networks\", \"genetic constraint\", \"meta analysis\", \"non-coding variant effects\", \"spatial gene expression variability\", \"TF binding\", \"variant TF binding effects\".", sep = ""))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`supersedes`)) {
        PredictionSetObject[["supersedes"]] <-
          self$`supersedes`
      }
      ...
      if (!is.null(self$`superseded_by`)) {
        PredictionSetObject[["superseded_by"]] <-
          self$`superseded_by`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_set_type`)) {
        if (!is.null(this_object$`file_set_type`) && !(this_object$`file_set_type` %in% c("chromatin accessibility", "coding variant effects", "coding variant effects on PPI", "coding variants pathogenicity", "disease associations", "element-gene links", "gene regulatory networks", "genetic constraint", "meta analysis", "non-coding variant effects", "spatial gene expression variability", "TF binding", "variant TF binding effects"))) {
          stop(paste("Error! \"", this_object$`file_set_type`, "\" cannot be assigned to `file_set_type`. Must be \"chromatin accessibility\", \"coding variant effects\", \"coding variant effects on PPI\", \"coding variants pathogenicity\", \"disease associations\", \"element-gene links\", \"gene regulatory networks\", \"genetic constraint\", \"meta analysis\", \"non-coding variant effects\", \"spatial gene expression variability\", \"TF binding\", \"variant TF binding effects\".", sep = ""))
        }
