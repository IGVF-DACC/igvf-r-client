  ...
  public = list(
    ...
    initialize = function(`preview_timestamp` = NULL, `release_timestamp` = NULL, `status` = NULL, `lab` = NULL, `award` = NULL, `attachment` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `document_type` = NULL, `characterization_method` = NULL, `urls` = NULL, `standardized_file_format` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, additional_properties = NULL, ...) {
      ...
      if (!is.null(`document_type`)) {
        if (!(`document_type` %in% c("cell fate change protocol", "characterization", "computational protocol", "experimental protocol", "file format specification", "image", "library structure seqspec", "model source data", "pipeline parameters", "plate map", "plasmid map", "plasmid sequence", "quality control report", "standards"))) {
          stop(paste("Error! \"", `document_type`, "\" cannot be assigned to `document_type`. Must be \"cell fate change protocol\", \"characterization\", \"computational protocol\", \"experimental protocol\", \"file format specification\", \"image\", \"library structure seqspec\", \"model source data\", \"pipeline parameters\", \"plate map\", \"plasmid map\", \"plasmid sequence\", \"quality control report\", \"standards\".", sep = ""))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`preview_timestamp`)) {
        DocumentObject[["preview_timestamp"]] <-
