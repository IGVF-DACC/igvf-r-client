  ...
  public = list(
    ...
    initialize = function(`preview_timestamp` = NULL, `release_timestamp` = NULL, `sources` = NULL, `lot_id` = NULL, `product_id` = NULL, `documents` = NULL, `status` = NULL, `lab` = NULL, `award` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `activated` = NULL, `activating_agent_term_id` = NULL, `activating_agent_term_name` = NULL, `modality` = NULL, `tagged_proteins` = NULL, `cas` = NULL, `fused_domain` = NULL, `cas_species` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `biosamples_modified` = NULL, ...) {
      ...
      if (!is.null(`fused_domain`)) {
        if (!(`fused_domain` %in% c("2xVP64", "2xVP64-2A-Puro", "2xVP64-2A-Thy1.1", "3xVP64", "ABE8e", "ABE8.20", "ANTI-FLAG", "BE4", "BE4max", "eA3A", "eA3A-T31A", "eA3A-T44D-S45A", "evoCDA", "KOX1-KRAB", "M-MLV RT (PE2)", "PEmax-La", "p300", "p300-2A-PuroR", "TdCBE", "TdCGBE", "TdDE", "Tet1", "VPH", "VP64", "VP64-p65-Rta (VPR)", "ZIM3-KRAB", "ZNF563KRAB"))) {
          stop(paste("Error! \"", `fused_domain`, "\" cannot be assigned to `fused_domain`. Must be \"2xVP64\", \"2xVP64-2A-Puro\", \"2xVP64-2A-Thy1.1\", \"3xVP64\", \"ABE8e\", \"ABE8.20\", \"ANTI-FLAG\", \"BE4\", \"BE4max\", \"eA3A\", \"eA3A-T31A\", \"eA3A-T44D-S45A\", \"evoCDA\", \"KOX1-KRAB\", \"M-MLV RT (PE2)\", \"PEmax-La\", \"p300\", \"p300-2A-PuroR\", \"TdCBE\", \"TdCGBE\", \"TdDE\", \"Tet1\", \"VPH\", \"VP64\", \"VP64-p65-Rta (VPR)\", \"ZIM3-KRAB\", \"ZNF563KRAB\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`fused_domain`)) {
        if (!is.null(this_object$`fused_domain`) && !(this_object$`fused_domain` %in% c("2xVP64", "2xVP64-2A-Puro", "2xVP64-2A-Thy1.1", "3xVP64", "ABE8e", "ABE8.20", "ANTI-FLAG", "BE4", "BE4max", "eA3A", "eA3A-T31A", "eA3A-T44D-S45A", "evoCDA", "KOX1-KRAB", "M-MLV RT (PE2)", "PEmax-La", "p300", "p300-2A-PuroR", "TdCBE", "TdCGBE", "TdDE", "Tet1", "VPH", "VP64", "VP64-p65-Rta (VPR)", "ZIM3-KRAB", "ZNF563KRAB"))) {
