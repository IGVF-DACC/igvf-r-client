...
#' @field primer_design_for Link(s) to the MeasurementSets using this file as a primer design. list(character) [optional]
...
TabularFile <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`anvil_url` = NULL, `catalog_collections` = NULL, `base_modifications` = NULL, `preview_timestamp` = NULL, `cell_type_annotation` = NULL, `controlled_access` = NULL, `assembly` = NULL, `release_timestamp` = NULL, `file_format_type` = NULL, `transcriptome_annotation` = NULL, `reference_files` = NULL, `filtered` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `derived_manually` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `checkfiles_version` = NULL, `catalog_adapters` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `quality_metrics` = NULL, `assay_titles` = NULL, `preferred_assay_titles` = NULL, `workflows` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, `barcode_map_for` = NULL, `primer_design_for` = NULL, ...) {
      ...
      if (!is.null(`assembly`)) {
        if (!(`assembly` %in% c("GRCh38", "hg19", "Cast - GRCm39", "GRCm39", "mm10", "GRCh38, mm10", "C57BL_6J_T2T_v1 + GRCm39_X", "CAST_EiJ_T2T_v1", "custom"))) {
          stop(paste("Error! \"", `assembly`, "\" cannot be assigned to `assembly`. Must be \"GRCh38\", \"hg19\", \"Cast - GRCm39\", \"GRCm39\", \"mm10\", \"GRCh38, mm10\", \"C57BL_6J_T2T_v1 + GRCm39_X\", \"CAST_EiJ_T2T_v1\", \"custom\".", sep = ""))
        }
      ...
      if (!is.null(`transcriptome_annotation`)) {
        if (!(`transcriptome_annotation` %in% c("GENCODE 22", "GENCODE 24", "GENCODE 28", "GENCODE 32", "GENCODE 38", "GENCODE 40", "GENCODE 41", "GENCODE 42", "GENCODE 43", "GENCODE 44", "GENCODE 45", "GENCODE 47", "GENCODE Cast - M32", "GENCODE M17", "GENCODE M25", "GENCODE M30", "GENCODE M31", "GENCODE M32", "GENCODE M33", "GENCODE M34", "GENCODE M36", "GENCODE 32, GENCODE M23"))) {
      ...
      if (!is.null(`primer_design_for`)) {
        stopifnot(is.vector(`primer_design_for`), length(`primer_design_for`) != 0)
        sapply(`primer_design_for`, function(x) stopifnot(is.character(x)))
        self$`primer_design_for` <- `primer_design_for`
      }
    },
    #' To JSON string
    #'
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`primer_design_for`)) {
        TabularFileObject[["primer_design_for"]] <-
          self$`primer_design_for`
      }
      TabularFileObject
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`assembly`)) {
        if (!is.null(this_object$`assembly`) && !(this_object$`assembly` %in% c("GRCh38", "hg19", "Cast - GRCm39", "GRCm39", "mm10", "GRCh38, mm10", "C57BL_6J_T2T_v1 + GRCm39_X", "CAST_EiJ_T2T_v1", "custom"))) {
          stop(paste("Error! \"", this_object$`assembly`, "\" cannot be assigned to `assembly`. Must be \"GRCh38\", \"hg19\", \"Cast - GRCm39\", \"GRCm39\", \"mm10\", \"GRCh38, mm10\", \"C57BL_6J_T2T_v1 + GRCm39_X\", \"CAST_EiJ_T2T_v1\", \"custom\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`primer_design_for`)) {
        self$`primer_design_for` <- ApiClient$new()$deserializeObj(this_object$`primer_design_for`, "set[character]", loadNamespace("igvfclient"))
      }
      self
    },
    #' To JSON string
      ...
      jsoncontent <- c(
        ...
        if (!is.null(self$`primer_design_for`)) {
          ...
          '"primer_design_for":
             [%s]
          ',
          paste(unlist(lapply(self$`primer_design_for`, function(x) paste0('"', x, '"'))), collapse = ",")
          )
        }
      )
