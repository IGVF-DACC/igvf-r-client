#' Create a new ATACFragmentSummaryStats
#'
#' @description
#' 
#'
#' @docType class
#' @title ATACFragmentSummaryStats
#' @description ATACFragmentSummaryStats Class
...
#' @export
ATACFragmentSummaryStats <- R6::R6Class(
  ...
  public = list(
    ...
    `width` = NULL,
    `height` = NULL,
    #' Initialize a new ATACFragmentSummaryStats class.
    #'
    #' @description
    #' Initialize a new ATACFragmentSummaryStats class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ATACFragmentSummaryStats in JSON format
    #' @export
    toJSON = function() {
      ATACFragmentSummaryStatsObject <- list()
      if (!is.null(self$`download`)) {
        ATACFragmentSummaryStatsObject[["download"]] <-
          self$`download`
      }
      if (!is.null(self$`href`)) {
        ATACFragmentSummaryStatsObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`type`)) {
        ATACFragmentSummaryStatsObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`size`)) {
        ATACFragmentSummaryStatsObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`md5sum`)) {
        ATACFragmentSummaryStatsObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`width`)) {
        ATACFragmentSummaryStatsObject[["width"]] <-
          self$`width`
      }
      if (!is.null(self$`height`)) {
        ATACFragmentSummaryStatsObject[["height"]] <-
          self$`height`
      }
      ATACFragmentSummaryStatsObject
    },
    #' Deserialize JSON string into an instance of ATACFragmentSummaryStats
    #'
    #' @description
    #' Deserialize JSON string into an instance of ATACFragmentSummaryStats
    #'
    #' @param input_json the JSON input
    #' @return the instance of ATACFragmentSummaryStats
    #' @export
    ...
    #' Validate JSON input with respect to ATACFragmentSummaryStats
    #'
    #' @description
    #' Validate JSON input with respect to ATACFragmentSummaryStats and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ATACFragmentSummaryStats
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ATACFragmentSummaryStats$unlock()
#
## Below is an example to define the print function
# ATACFragmentSummaryStats$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ATACFragmentSummaryStats$lock()
