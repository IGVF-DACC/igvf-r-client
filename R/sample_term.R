  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`preview_timestamp`)) {
        SampleTermObject[["preview_timestamp"]] <-
      ...
      if (!is.null(self$`definition`)) {
        SampleTermObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`comments`)) {
        SampleTermObject[["comments"]] <-
          self$`comments`
      }
