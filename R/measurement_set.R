...
#' @field strand_specificity Indicates which strand of the original RNA molecule the transcriptomic library represents. '5 prime to 3 prime' (forward) libraries generate cDNA corresponding to the same strand as the RNA, while '3 prime to 5 prime' (reverse) libraries generate cDNA complementary to the RNA. This property is independent of the physical direction of sequencing reads. character [optional]
...
#' @field targeted_genes A list of genes that are the primary focus of this assay. For example, TF ChIP-seq attempts to identify binding sites of a protein encoded by a specific gene. In CRISPR FACS screens where the assay investigates abundance or expression of a specific gene, list that gene here. When a gene is used only as a sort or differentiation marker and is not the primary focus of the experiment, use biomarkers.gene on the sample instead and omit targeted_genes. This property differs from small_scale_gene_list in Construct Library Set, which describes genes targeted by the content integrated in the constructs (such as guide RNAs). list(character) [optional]
...
MeasurementSet <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param strand_specificity Indicates which strand of the original RNA molecule the transcriptomic library represents. '5 prime to 3 prime' (forward) libraries generate cDNA corresponding to the same strand as the RNA, while '3 prime to 5 prime' (reverse) libraries generate cDNA complementary to the RNA. This property is independent of the physical direction of sequencing reads.
    ...
    initialize = function(`is_on_anvil` = NULL, `doi` = NULL, `preferred_assay_titles` = NULL, `preview_timestamp` = NULL, `control_file_sets` = NULL, `release_timestamp` = NULL, `publications` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `dbxrefs` = NULL, `samples` = NULL, `donors` = NULL, `file_set_type` = NULL, `supersedes` = NULL, `assay_term` = NULL, `crispr_screen_readout` = NULL, `crispr_screen_biometric` = NULL, `protocols` = NULL, `multiome_size` = NULL, `control_types` = NULL, `sequencing_library_types` = NULL, `enrichment_designs` = NULL, `strand_specificity` = NULL, `auxiliary_sets` = NULL, `external_image_urls` = NULL, `targeted_genes` = NULL, `targeted_proteins` = NULL, `functional_assay_mechanisms` = NULL, `onlist_method` = NULL, `onlist_files` = NULL, `barcode_replacement_file` = NULL, `library_preparation_kit` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `files` = NULL, `control_for` = NULL, `superseded_by` = NULL, `submitted_files_timestamp` = NULL, `input_for` = NULL, `construct_library_sets` = NULL, `data_use_limitation_summaries` = NULL, `controlled_access` = NULL, `assay_titles` = NULL, `assay_slims` = NULL, `related_measurement_sets` = NULL, `externally_hosted` = NULL, `preferred_assay_slims` = NULL, additional_properties = NULL, ...) {
      ...
      if (!is.null(`strand_specificity`)) {
        if (!(`strand_specificity` %in% c("5 prime to 3 prime", "3 prime to 5 prime", "unstranded"))) {
          stop(paste("Error! \"", `strand_specificity`, "\" cannot be assigned to `strand_specificity`. Must be \"5 prime to 3 prime\", \"3 prime to 5 prime\", \"unstranded\".", sep = ""))
        }
      ...
      if (!is.null(`library_preparation_kit`)) {
        if (!(`library_preparation_kit` %in% c("10X Chromium Single Cell 3 prime v1", "10X Chromium Single Cell 3 prime v2", "10X Chromium Single Cell 3 prime v3", "10X Chromium Single Cell 3 prime v3.1", "10X Chromium Single Cell 3 prime v4", "10X Chromium Single Cell 5 prime v1", "10X Chromium Single Cell 5 prime v2", "10X Chromium Single Cell 5 prime v3", "10X Chromium Single Cell Multiome ATAC + Gene Expression"))) {
          stop(paste("Error! \"", `library_preparation_kit`, "\" cannot be assigned to `library_preparation_kit`. Must be \"10X Chromium Single Cell 3 prime v1\", \"10X Chromium Single Cell 3 prime v2\", \"10X Chromium Single Cell 3 prime v3\", \"10X Chromium Single Cell 3 prime v3.1\", \"10X Chromium Single Cell 3 prime v4\", \"10X Chromium Single Cell 5 prime v1\", \"10X Chromium Single Cell 5 prime v2\", \"10X Chromium Single Cell 5 prime v3\", \"10X Chromium Single Cell Multiome ATAC + Gene Expression\".", sep = ""))
        }
      ...
      if (!is.null(`related_measurement_sets`)) {
        stopifnot(is.vector(`related_measurement_sets`), length(`related_measurement_sets`) != 0)
        sapply(`related_measurement_sets`, function(x) stopifnot(R6::is.R6(x)))
        self$`related_measurement_sets` <- `related_measurement_sets`
      }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`preview_timestamp`)) {
        MeasurementSetObject[["preview_timestamp"]] <-
      ...
      if (!is.null(self$`assay_slims`)) {
        MeasurementSetObject[["assay_slims"]] <-
          self$`assay_slims`
      }
      if (!is.null(self$`related_measurement_sets`)) {
        MeasurementSetObject[["related_measurement_sets"]] <-
          lapply(self$`related_measurement_sets`, function(x) x$toJSON())
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`library_preparation_kit`)) {
        if (!is.null(this_object$`library_preparation_kit`) && !(this_object$`library_preparation_kit` %in% c("10X Chromium Single Cell 3 prime v1", "10X Chromium Single Cell 3 prime v2", "10X Chromium Single Cell 3 prime v3", "10X Chromium Single Cell 3 prime v3.1", "10X Chromium Single Cell 3 prime v4", "10X Chromium Single Cell 5 prime v1", "10X Chromium Single Cell 5 prime v2", "10X Chromium Single Cell 5 prime v3", "10X Chromium Single Cell Multiome ATAC + Gene Expression"))) {
      ...
      if (!is.null(this_object$`related_measurement_sets`)) {
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`related_measurement_sets`)) {
          ...
          [%s]
',
          paste(sapply(self$`related_measurement_sets`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox = TRUE, digits = NA)), collapse = ",")
          )
        },
        if (!is.null(self$`externally_hosted`)) {
          sprintf(
