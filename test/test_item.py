...
test_that("analysis_step_types", {
  # tests for the property `analysis_step_types` (List[str])
...
test_that("step_label", {
  # tests for the property `step_label` (str)
...
test_that("workflow", {
  # tests for the property `workflow` (str)
...
test_that("parents", {
  # tests for the property `parents` (List[str])
  # The precursor steps.
...
test_that("input_content_types", {
  # tests for the property `input_content_types` (List[str])
...
test_that("output_content_types", {
  # tests for the property `output_content_types` (List[str])
...
test_that("start_date", {
  # tests for the property `start_date` (str)
...
test_that("end_date", {
  # tests for the property `end_date` (str)
...
test_that("pis", {
  # tests for the property `pis` (List[str])
...
test_that("contact_pi", {
  # tests for the property `contact_pi` (str)
...
test_that("project", {
  # tests for the property `project` (str)
...
test_that("viewing_group", {
  # tests for the property `viewing_group` (str)
...
test_that("component", {
  # tests for the property `component` (str)
...
test_that("gene", {
  # tests for the property `gene` (List[str])
...
test_that("assembly", {
  # tests for the property `assembly` (str)
...
test_that("reference_files", {
  # tests for the property `reference_files` (List[str])
...
test_that("redacted", {
  # tests for the property `redacted` (bool)
...
test_that("filtered", {
  # tests for the property `filtered` (bool)
...
test_that("content_summary", {
  # tests for the property `content_summary` (str)
...
test_that("seqspec_of", {
  # tests for the property `seqspec_of` (List[str])
...
test_that("file_format_type", {
  # tests for the property `file_format_type` (str)
...
test_that("dimension1", {
  # tests for the property `dimension1` (str)
...
test_that("dimension2", {
  # tests for the property `dimension2` (str)
...
test_that("external", {
  # tests for the property `external` (bool)
...
test_that("external_id", {
  # tests for the property `external_id` (str)
...
test_that("strand_specificity", {
  # tests for the property `strand_specificity` (str)
...
test_that("normalized", {
  # tests for the property `normalized` (bool)
...
test_that("start_view_position", {
  # tests for the property `start_view_position` (str)
...
test_that("assay_titles", {
  # tests for the property `assay_titles` (List[str])
...
test_that("selection_criteria", {
  # tests for the property `selection_criteria` (List[str])
...
test_that("integrated_content_files", {
  # tests for the property `integrated_content_files` (List[str])
...
test_that("associated_phenotypes", {
  # tests for the property `associated_phenotypes` (List[str])
...
test_that("orf_list", {
  # tests for the property `orf_list` (List[str])
...
test_that("exon", {
  # tests for the property `exon` (str)
...
test_that("guide_type", {
  # tests for the property `guide_type` (str)
...
test_that("tiling_modality", {
  # tests for the property `tiling_modality` (str)
...
test_that("average_guide_coverage", {
  # tests for the property `average_guide_coverage` (float)
...
test_that("lower_bound_guide_coverage", {
  # tests for the property `lower_bound_guide_coverage` (int)
...
test_that("upper_bound_guide_coverage", {
  # tests for the property `upper_bound_guide_coverage` (int)
...
test_that("average_insert_size", {
  # tests for the property `average_insert_size` (float)
...
test_that("lower_bound_insert_size", {
  # tests for the property `lower_bound_insert_size` (int)
...
test_that("upper_bound_insert_size", {
  # tests for the property `upper_bound_insert_size` (int)
...
test_that("targeton", {
  # tests for the property `targeton` (str)
...
test_that("applied_to_samples", {
  # tests for the property `applied_to_samples` (List[str])
...
test_that("assemblies", {
  # tests for the property `assemblies` (List[str])
...
test_that("transcriptome_annotations", {
  # tests for the property `transcriptome_annotations` (List[str])
...
test_that("model_name", {
  # tests for the property `model_name` (str)
...
test_that("model_version", {
  # tests for the property `model_version` (str)
...
test_that("prediction_objects", {
  # tests for the property `prediction_objects` (List[str])
...
test_that("model_zoo_location", {
  # tests for the property `model_zoo_location` (str)
...
test_that("software_version", {
  # tests for the property `software_version` (str)
...
test_that("caption", {
  # tests for the property `caption` (str)
...
test_that("thumb_nail", {
  # tests for the property `thumb_nail` (str)
  # Image url
...
test_that("download_url", {
  # tests for the property `download_url` (str)
  # Download Url
...
test_that("awards", {
  # tests for the property `awards` (List[str])
...
test_that("institute_label", {
  # tests for the property `institute_label` (str)
...
test_that("activated", {
  # tests for the property `activated` (bool)
...
test_that("activating_agent_term_id", {
  # tests for the property `activating_agent_term_id` (str)
...
test_that("activating_agent_term_name", {
  # tests for the property `activating_agent_term_name` (str)
...
test_that("modality", {
  # tests for the property `modality` (str)
...
test_that("cas", {
  # tests for the property `cas` (str)
...
test_that("fused_domain", {
  # tests for the property `fused_domain` (str)
...
test_that("tagged_protein", {
  # tests for the property `tagged_protein` (str)
...
test_that("cas_species", {
  # tests for the property `cas_species` (str)
...
test_that("biosamples_modified", {
  # tests for the property `biosamples_modified` (List[str])
...
test_that("degron_system", {
  # tests for the property `degron_system` (str)
...
test_that("tagged_proteins", {
  # tests for the property `tagged_proteins` (List[str])
...
test_that("term_id", {
  # tests for the property `term_id` (str)
...
test_that("term_name", {
  # tests for the property `term_name` (str)
...
test_that("deprecated_ntr_terms", {
  # tests for the property `deprecated_ntr_terms` (List[str])
...
test_that("is_a", {
  # tests for the property `is_a` (List[str])
...
test_that("preferred_assay_titles", {
  # tests for the property `preferred_assay_titles` (List[str])
...
test_that("ancestors", {
  # tests for the property `ancestors` (List[str])
...
test_that("ontology", {
  # tests for the property `ontology` (str)
...
test_that("assay_slims", {
  # tests for the property `assay_slims` (List[str])
...
test_that("category_slims", {
  # tests for the property `category_slims` (List[str])
...
test_that("objective_slims", {
  # tests for the property `objective_slims` (List[str])
...
test_that("company", {
  # tests for the property `company` (str)
...
test_that("sequencing_kits", {
  # tests for the property `sequencing_kits` (List[str])
...
test_that("organ_slims", {
  # tests for the property `organ_slims` (List[str])
...
test_that("cell_slims", {
  # tests for the property `cell_slims` (List[str])
...
test_that("developmental_slims", {
  # tests for the property `developmental_slims` (List[str])
...
test_that("system_slims", {
  # tests for the property `system_slims` (List[str])
...
test_that("orf_id", {
  # tests for the property `orf_id` (str)
...
test_that("protein_id", {
  # tests for the property `protein_id` (str)
...
test_that("pct_identical_protein", {
  # tests for the property `pct_identical_protein` (float)
...
test_that("pct_coverage_protein", {
  # tests for the property `pct_coverage_protein` (float)
...
test_that("pct_coverage_orf", {
  # tests for the property `pct_coverage_orf` (float)
...
test_that("software", {
  # tests for the property `software` (str)
...
test_that("multiplexed_samples", {
  # tests for the property `multiplexed_samples` (List[str])
...
test_that("barcode_sample_map", {
  # tests for the property `barcode_sample_map` (str)
...
test_that("sample_material", {
  # tests for the property `sample_material` (str)
...
test_that("pmi", {
  # tests for the property `pmi` (int)
...
test_that("pmi_units", {
  # tests for the property `pmi_units` (str)
...
test_that("ccf_id", {
  # tests for the property `ccf_id` (str)
...
test_that("preservation_method", {
  # tests for the property `preservation_method` (str)
...
test_that("version", {
  # tests for the property `version` (str)
...
test_that("download_id", {
  # tests for the property `download_id` (str)
...
test_that("downloaded_url", {
  # tests for the property `downloaded_url` (str)
...
test_that("amount", {
  # tests for the property `amount` (float)
...
test_that("amount_units", {
  # tests for the property `amount_units` (str)
...
test_that("duration", {
  # tests for the property `duration` (float)
...
test_that("duration_units", {
  # tests for the property `duration_units` (str)
  # A unit of time.
...
test_that("p_h", {
  # tests for the property `p_h` (float)
  # Final pH of the solution containing a chemical compound (if applicable)

  # uncomment below to test the property
  #expect_equal(model.instance$`p_h`, "EXPECTED_RESULT")
})

test_that("purpose", {
  # tests for the property `purpose` (str)
...
test_that("post_treatment_time", {
  # tests for the property `post_treatment_time` (float)
...
test_that("post_treatment_time_units", {
  # tests for the property `post_treatment_time_units` (str)
  # A unit of time.
...
test_that("temperature", {
  # tests for the property `temperature` (float)
...
test_that("temperature_units", {
  # tests for the property `temperature_units` (str)
...
test_that("treatment_type", {
  # tests for the property `treatment_type` (str)
...
test_that("treatment_term_id", {
  # tests for the property `treatment_term_id` (str)
...
test_that("treatment_term_name", {
  # tests for the property `treatment_term_name` (str)
...
test_that("depletion", {
  # tests for the property `depletion` (bool)
...
test_that("biosamples_treated", {
  # tests for the property `biosamples_treated` (List[str])
...
test_that("email", {
  # tests for the property `email` (str)
...
test_that("first_name", {
  # tests for the property `first_name` (str)
...
test_that("last_name", {
  # tests for the property `last_name` (str)
...
test_that("submits_for", {
  # tests for the property `submits_for` (List[str])
...
test_that("groups", {
  # tests for the property `groups` (List[str])
...
test_that("viewing_groups", {
  # tests for the property `viewing_groups` (List[str])
  # The group that determines which set of data the user has permission to view.
...
test_that("job_title", {
  # tests for the property `job_title` (str)
...
test_that("workflow_repositories", {
  # tests for the property `workflow_repositories` (List[str])
...
test_that("standards_page", {
  # tests for the property `standards_page` (str)
...
test_that("workflow_version", {
  # tests for the property `workflow_version` (int)
...
test_that("analysis_steps", {
  # tests for the property `analysis_steps` (List[str])
