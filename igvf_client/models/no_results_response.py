...
#' @field id   [optional]
#' @field type   [optional]
#' @field clear_filters   [optional]
#' @field columns   [optional]
#' @field facet_groups   [optional]
#' @field facets   [optional]
#' @field filters   [optional]
#' @field notification   [optional]
#' @field sort   [optional]
  ...
  public = list(
    ...
    initialize = function(`context` = NULL, `graph` = NULL, `id` = NULL, `type` = NULL, `clear_filters` = NULL, `columns` = NULL, `facet_groups` = NULL, `facets` = NULL, `filters` = NULL, `notification` = NULL, `sort` = NULL, `title` = NULL, `total` = NULL, ...) {
      ...
      if (!is.null(`graph`)) {
        ...
        sapply(`graph`, function(x) stopifnot(is.character(x)))
        self$`graph` <- `graph`
      }
      if (!is.null(`id`)) {
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`@graph`)) {
        self$`graph` <- ApiClient$new()$deserializeObj(this_object$`@graph`, "List[object]", loadNamespace("igvf_client"))
      }
      ...
      if (!is.null(this_object$`columns`)) {
        self$`columns` <- ApiClient$new()$deserializeObj(this_object$`columns`, "Dict[str, NoResultsResponseColumnsValue]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`facet_groups`)) {
        self$`facet_groups` <- ApiClient$new()$deserializeObj(this_object$`facet_groups`, "List[NoResultsResponseFacetGroupsInner]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`facets`)) {
        self$`facets` <- ApiClient$new()$deserializeObj(this_object$`facets`, "List[NoResultsResponseFacetsInner]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`filters`)) {
        self$`filters` <- ApiClient$new()$deserializeObj(this_object$`filters`, "List[NoResultsResponseFiltersInner]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`notification`)) {
        self$`notification` <- this_object$`notification`
      }
      if (!is.null(this_object$`sort`)) {
        self$`sort` <- ApiClient$new()$deserializeObj(this_object$`sort`, "Dict[str, NoResultsResponseSortValue]", loadNamespace("igvf_client"))
      }
      ...
      jsoncontent <- c(
        ...
        if (!is.null(self$`graph`)) {
          ...
          '"@graph":
             [%s]
          ',
          paste(unlist(lapply(self$`graph`, function(x) paste0('"', x, '"'))), collapse = ",")
          )
        },
        if (!is.null(self$`id`)) {
          sprintf(
        ...
        if (!is.null(self$`columns`)) {
          ...
          %s
',
          jsonlite::toJSON(lapply(self$`columns`, function(x){ x$toJSON() }), auto_unbox = TRUE, digits = NA)
          )
        },
        if (!is.null(self$`facet_groups`)) {
          sprintf(
...
',
        ...
        if (!is.null(self$`sort`)) {
          ...
          %s
',
          jsonlite::toJSON(lapply(self$`sort`, function(x){ x$toJSON() }), auto_unbox = TRUE, digits = NA)
          )
        },
        if (!is.null(self$`title`)) {
          sprintf(
