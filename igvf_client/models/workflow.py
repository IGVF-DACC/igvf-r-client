...
#' @field workflow_repositories   [optional]
#' @field standards_page   [optional]
#' @field workflow_version   [optional]
#' @field id   [optional]
#' @field type   [optional]
#' @field summary   [optional]
#' @field analysis_steps   [optional]
...
Workflow <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param name 
    #' @param source_url 
    #' @param workflow_repositories 
    #' @param standards_page 
    #' @param workflow_version 
    #' @param id id
    #' @param type type
    #' @param summary 
    #' @param analysis_steps 
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`workflow_repositories`)) {
        self$`workflow_repositories` <- ApiClient$new()$deserializeObj(this_object$`workflow_repositories`, "List[str]", loadNamespace("igvf_client"))
      }
      ...
      if (!is.null(this_object$`analysis_steps`)) {
        self$`analysis_steps` <- ApiClient$new()$deserializeObj(this_object$`analysis_steps`, "List[str]", loadNamespace("igvf_client"))
      }
      self
    },
    #' To JSON string
