...
SearchFacet <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`var_field` = NULL, `title` = NULL, `terms` = NULL, ...) {
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`terms`)) {
        self$`terms` <- ApiClient$new()$deserializeObj(this_object$`terms`, "List[object]", loadNamespace("igvf_client"))
      }
      self
    },
    #' To JSON string
