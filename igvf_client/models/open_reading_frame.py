...
#' @field orf_id   [optional]
#' @field gene   [optional]
#' @field protein_id   [optional]
#' @field dbxrefs   [optional]
#' @field pct_identical_protein   [optional]
#' @field pct_coverage_protein   [optional]
#' @field pct_coverage_orf   [optional]
#' @field id   [optional]
#' @field type   [optional]
...
OpenReadingFrame <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param protein_id 
    #' @param dbxrefs 
    #' @param pct_identical_protein 
    #' @param pct_coverage_protein 
    #' @param pct_coverage_orf 
    #' @param id id
    #' @param type type
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`gene`)) {
        self$`gene` <- ApiClient$new()$deserializeObj(this_object$`gene`, "List[str]", loadNamespace("igvf_client"))
      }
