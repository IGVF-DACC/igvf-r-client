...
#' @field time_post_change   [optional]
#' @field time_post_change_units   [optional]
#' @field cell_fate_change_treatments   [optional]
#' @field cell_fate_change_protocol   [optional]
#' @field demultiplexed_from   [optional]
#' @field passage_number   [optional]
#' @field targeted_sample_term   [optional]
#' @field growth_medium   [optional]
#' @field id   [optional]
#' @field type   [optional]
...
#' @field demultiplexed_to   [optional]
...
InVitroSystem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param time_post_change 
    #' @param time_post_change_units 
    #' @param cell_fate_change_treatments 
    #' @param cell_fate_change_protocol 
    #' @param demultiplexed_from 
    #' @param passage_number 
    #' @param targeted_sample_term 
    #' @param growth_medium 
    #' @param id id
    #' @param type type
    #' @param summary 
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`cell_fate_change_treatments`)) {
        self$`cell_fate_change_treatments` <- ApiClient$new()$deserializeObj(this_object$`cell_fate_change_treatments`, "List[str]", loadNamespace("igvf_client"))
      }
      ...
      if (!is.null(this_object$`demultiplexed_to`)) {
        self$`demultiplexed_to` <- ApiClient$new()$deserializeObj(this_object$`demultiplexed_to`, "List[str]", loadNamespace("igvf_client"))
      }
      self
    },
    #' To JSON string
