...
#' @field name   [optional]
#' @field start_date   [optional]
#' @field end_date   [optional]
#' @field pis   [optional]
#' @field contact_pi   [optional]
#' @field project   [optional]
#' @field viewing_group   [optional]
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`pis`)) {
        self$`pis` <- ApiClient$new()$deserializeObj(this_object$`pis`, "List[str]", loadNamespace("igvf_client"))
      }
