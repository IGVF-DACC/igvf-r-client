...
PredictionSet <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new PredictionSet.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "object"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize PredictionSet with oneOf schemas object. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste(error_messages, collapse = " >> "), paste("Multiple matches found when deserializing the input into PredictionSet with oneOf schemas object. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into PredictionSet with oneOf schemas object. Details: >>",
