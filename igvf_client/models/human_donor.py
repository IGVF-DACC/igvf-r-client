...
#' @field related_donors   [optional]
#' @field ethnicities   [optional]
#' @field human_donor_identifiers   [optional]
#' @field id   [optional]
#' @field type   [optional]
...
HumanDonor <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param virtual 
    #' @param related_donors 
    #' @param ethnicities 
    #' @param human_donor_identifiers 
    #' @param id id
    #' @param type type
    #' @param summary 
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`related_donors`)) {
        self$`related_donors` <- ApiClient$new()$deserializeObj(this_object$`related_donors`, "List[RelatedDonor]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`ethnicities`)) {
        self$`ethnicities` <- ApiClient$new()$deserializeObj(this_object$`ethnicities`, "List[str]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`human_donor_identifiers`)) {
        self$`human_donor_identifiers` <- ApiClient$new()$deserializeObj(this_object$`human_donor_identifiers`, "List[str]", loadNamespace("igvf_client"))
      }
