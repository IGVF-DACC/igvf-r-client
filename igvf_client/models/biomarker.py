...
#' @field name   [optional]
#' @field classification   [optional]
#' @field quantification   [optional]
#' @field synonyms   [optional]
#' @field gene   [optional]
#' @field id   [optional]
#' @field type   [optional]
#' @field summary   [optional]
#' @field name_quantification   [optional]
#' @field biomarker_for   [optional]
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`biomarker_for`)) {
        self$`biomarker_for` <- ApiClient$new()$deserializeObj(this_object$`biomarker_for`, "List[str]", loadNamespace("igvf_client"))
      }
      self
    },
    #' To JSON string
