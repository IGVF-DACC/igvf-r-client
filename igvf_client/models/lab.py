...
#' @field name   [optional]
#' @field pi   [optional]
#' @field awards   [optional]
#' @field institute_label   [optional]
#' @field id   [optional]
#' @field type   [optional]
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`awards`)) {
        self$`awards` <- ApiClient$new()$deserializeObj(this_object$`awards`, "List[str]", loadNamespace("igvf_client"))
      }
