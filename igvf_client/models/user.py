...
#' @field last_name   [optional]
#' @field lab   [optional]
#' @field submits_for   [optional]
#' @field groups   [optional]
#' @field viewing_groups   [optional]
#' @field job_title   [optional]
#' @field id   [optional]
#' @field type   [optional]
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`submits_for`)) {
        self$`submits_for` <- ApiClient$new()$deserializeObj(this_object$`submits_for`, "List[str]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`groups`)) {
        self$`groups` <- ApiClient$new()$deserializeObj(this_object$`groups`, "List[str]", loadNamespace("igvf_client"))
      }
      if (!is.null(this_object$`viewing_groups`)) {
        self$`viewing_groups` <- ApiClient$new()$deserializeObj(this_object$`viewing_groups`, "List[str]", loadNamespace("igvf_client"))
      }
