  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize WholeOrganism with anyOf schemas object. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      # no match
      stop(paste("No match found when deserializing the input into WholeOrganism with anyOf schemas object. Details: >>",
