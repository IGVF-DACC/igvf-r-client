...
The R client is autogenerated based on this [IGVF OpenAPI specification](https://github.com/IGVF-DACC/igvf-client-openapi-spec/blob/main/openapi_spec.json). It exposes search and collection endpoints from [https://data.igvf.org](https://data.igvf.org).
...
See other examples in [examples.ipynb](examples.ipynb) (test_endpoints.R)[https://github.com/IGVF-DACC/igvf-r-client/blob/main/tests/test_endpoints.R].
