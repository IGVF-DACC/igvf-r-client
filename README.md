...
cd igvf-r-client
R CMD build .
R CMD check igvfclient_0.1.0.tar.gz --no-manual
R CMD INSTALL --preclean igvfclient_0.1.0.tar.gz
```
...
```R
install.packages("igvfclient_0.1.0.tar.gz", repos = NULL, type = "source")
```
