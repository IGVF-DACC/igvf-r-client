...
cd igvf-r-client
R CMD build .
R CMD check igvfclient_46.0.2.tar.gz --no-manual
R CMD INSTALL --preclean igvfclient_46.0.2.tar.gz
```
...
```R
install.packages("igvfclient_46.0.2.tar.gz", repos = NULL, type = "source")
```
