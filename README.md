# R client for the [IGVF API](https://data.igvf.org/)

This R client is autogenerated based on the [IGVF OpenAPI specification](https://github.com/IGVF-DACC/igvf-client-openapi-spec/blob/main/openapi_spec.json).
