...
**purpose** | **character** | The intended purpose for treating the samples. | [optional] [Enum: [activation, acute stimulation, agonist, antagonist, chronic stimulation, control, de-differentiation, differentiation, perturbation, selection, stimulation]] 
...
**treatment_type** | **character** | The classification of treatment agent that specifies its exact molecular nature.  | [optional] [Enum: [chemical, protein, diet]] 
**treatment_term_id** | **character** | Ontology identifier describing a component in the treatment. | [optional] [Pattern: ^((CHEBI:[0-9]{1,7})|(UniProtKB:[A-Z0-9]{6})|(NTR:[0-9]{2,8})|(NCIT:C[0-9]{2,8}))$] 
