...
**file_format** | **character** | The file format or extension of the file. | [optional] [Enum: [bed, bedpe, bigBed, bigInteract, csv, gtf, gvcf, tar, tsv, vcf]] 
...
**assembly** | **character** | The assembly associated with the tabular file. | [optional] 
...
**strand_specificity** | **character** | Indicates which strand of the original RNA molecule the transcriptomic library represents. &#39;5 prime to 3 prime&#39; (forward) libraries generate cDNA corresponding to the same strand as the RNA, while &#39;3 prime to 5 prime&#39; (reverse) libraries generate cDNA complementary to the RNA. This property is independent of the physical direction of sequencing reads. | [optional] [Enum: [5 prime to 3 prime, 3 prime to 5 prime, unstranded]] 
...
**submitted_assembly** | **character** | Genome assembly for a tabular file. | [optional] [Enum: [GRCh38, hg19, Cast - GRCm39, GRCm39, mm10, GRCh38, GRCm39, GRCh38, mm10, C57BL_6J_T2T_v1 + GRCm39_X, CAST_EiJ_T2T_v1, custom, unknown]] 
**submitted_transcriptome_annotation** | **character** | The annotation and version of the reference resource. | [optional] [Enum: [GENCODE 22, GENCODE 24, GENCODE 28, GENCODE 32, GENCODE 34, GENCODE 38, GENCODE 40, GENCODE 41, GENCODE 42, GENCODE 43, GENCODE 44, GENCODE 45, GENCODE 47, GENCODE Cast - M32, GENCODE M17, GENCODE M25, GENCODE M30, GENCODE M31, GENCODE M32, GENCODE M33, GENCODE M34, GENCODE M36, GENCODE 32, GENCODE M23, GENCODE 41, GENCODE M25, GENCODE 44, GENCODE M33, CAST_EiJ_T2T_v1_TA1, C57BL_6J_T2T_v1_TA1 + M36_X, unknown]] 
**barcode_map_for** | **set[character]** | Link(s) to the Multiplexed samples using this file as barcode map. | [optional] 
**enrichment_design_for** | **set[character]** | Link(s) to the measurement sets using this file as a enrichment design. | [optional] 
**hashtag_barcode_map_for** | **set[character]** | Link(s) to the auxiliary sets using this file as a hashtag barcode map. | [optional] 
...
**subset_samples** | **set[character]** | The subset of sample(s) this analysis set represents, such as demultiplexed constituents or a timepoint from a differentiation series. Takes priority over samples inferred from input_file_sets when calculating samples and simplified_sample_summary. | [optional] 
**condition_treatments** | **set[character]** | Treatments that define the experimental condition(s) this analysis set represents. | [optional] 
...
**simplified_sample_summary** | **character** | A summary of the samples associated with input file sets of this analysis set. | [optional] 
...
**small_scale_orf_list** | **set[character]** | The specific, small scale list of (&lt;&#x3D;500) Open Reading Frame this construct library was designed to target. | [optional] 
**large_scale_orf_list** | **character** | The large scale list of (&gt;100 ORF) this construct library was designed to target. | [optional] 
...
**chromosomes** | **set[character]** | The list of chromosomes this construct library was designed to target. | [optional] 
...
**external_image_urls** | **array[character]** | Links to the external site where images produced by this measurement are stored. | [optional] 
...
**cell_type** | **character** | The ontology term that describes the cell type of the cells in this pseudobulk and/or pseudobulk-derived prediction. | [optional] 
...
**cell_annotation** | **character** |  | [optional] 
...
**demultiplexed_to** | **set[character]** | The in vitro system samples this multiplexed sample has been demultiplexed into. | [optional] 
...
**targeted_sample_terms** | **set[character]** | The targeted sample terms of subsamples that are a part of this multiplexed sample. | [optional] 
