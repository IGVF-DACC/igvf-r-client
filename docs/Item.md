...
**crispr_readout** | **character** | The sequencing readout produced by this CRISPR measurement set. | [optional] [Enum: [gRNA sequencing, endogenous allelic sequencing, exogenous allelic sequencing, scRNA-seq, scRNA-seq with guide capture, scATAC-seq]] 
