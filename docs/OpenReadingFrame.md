...
**barcode_sequence** | **character** | DNA sequence of the unique barcode identifier of the overexpressed construct | [optional] [Pattern: ^[ACGT]+$] 
**orf_sequence** | **character** | DNA sequence of the ORF specifically (this is a subset of the Insert DNA sequence) | [optional] [Pattern: ^[ACGT]+$] 
**insert_sequence** | **character** | DNA sequence of longer construct | [optional] [Pattern: ^[ACGT]+$] 
