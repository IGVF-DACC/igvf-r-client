...
**term_id** | **character** | An ontology term identifier describing a phenotype. | [optional] [Pattern: ^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$] 
