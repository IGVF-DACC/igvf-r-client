...
**file_set_type** | **character** | The category that best describes this curated file set. | [optional] [Enum: [barcodes, editing templates, elements, external data for catalog, external sequencing data, functional effect, genome, genes, guide RNAs, pathway gene mapping, pipeline parameters, enrichment designs, QTL, training data for predictive models, transcriptome, variants]] 
...
**versions** | **set[character]** | The versions of the reference files for external data loaded into the IGVF catalog. | [optional] 
