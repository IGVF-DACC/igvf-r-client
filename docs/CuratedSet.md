...
**file_set_type** | **character** | The category that best describes this curated file set. | [optional] [Enum: [barcodes, editing templates, elements, external data for catalog, genome, genes, guide RNAs, pipeline parameters, primer design, training data for predictive models, transcriptome, variants]] 
