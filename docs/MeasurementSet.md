...
**control_type** | **character** | The type of control this file set represents. | [optional] [Enum: [baseline, control transduction, low FACS signal, non-targeting, pre-selection, unsorted FACS input, untransfected, untreated]] 
