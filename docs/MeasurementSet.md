...
**control_type** | **character** | The type of control this file set represents. | [optional] [Enum: [baseline, reference transduction, low FACS signal, non-targeting, unsorted FACS input, untransfected, untreated]] 
