...
**control_type** | **character** | The type of control this file set represents. | [optional] [Enum: [control transduction, low FACS signal, non-targeting, pre-selection, unsorted FACS input, untransfected, untreated]] 
...
**strand_specificity** | **character** | The strand-specificity of the sequencing results within Perturb-seq, scCRISPR screen, TAP-seq, and CERES-seq assays. | [optional] [Enum: [5&#39; to 3&#39;, 3&#39; to 5&#39;, unstranded]] 
