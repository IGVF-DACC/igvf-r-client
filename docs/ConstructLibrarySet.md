...
**file_set_type** | **str** | The type or category of this construct library set. | [optional] [Enum: [guide library, reporter library, expression vector library, editing template library]] 
