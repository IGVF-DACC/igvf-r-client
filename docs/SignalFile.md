...
**file_format** | **character** | The file format or extension of the file. | [optional] [Enum: [bigWig, npz, tar]] 
...
**assembly** | **character** | The assembly associated with the signal file. | [optional] 
