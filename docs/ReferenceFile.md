...
**assembly** | **str** | Genome assembly applicable for the reference data. | [optional] [Enum: [GRCh38, hg19, GRCm39, mm10]] 
...
**file_format** | **str** | The file format or extension of the file. | [optional] [Enum: [bed, csv, dat, fasta, gaf, gds, gtf, obo, owl, PWM, tar, tsv, txt, vcf, xml]] 
