...
**assembly** | **character** | Genome assembly applicable for the reference data. | [optional] [Enum: [GRCh38, hg19, 129S1/SvImJ - GRCm39, A/J - GRCm39, Cast/EiJ - GRCm39, NOD/ShiLtJ - GRCm39, NZO/H1LtJ - GRCm39, PWK/PhJ - GRCm39, WSB/EiJ - GRCm39, GRCm39, mm10, GRCh38, GRCm39, GRCh38, mm10, C57BL_6J_T2T_v1 + GRCm39_X, CAST_EiJ_T2T_v1, custom]] 
...
**file_format** | **character** | The file format or extension of the file. | [optional] [Enum: [bed, csv, dat, fasta, gaf, gds, gtf, obo, owl, PWM, run, tar, tsv, txt, vcf, xml]] 
