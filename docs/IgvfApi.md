...
var_query <-  # str | Query string for searching. (Optional)
var_limit <-  # Limit | Maximum number of results to return. Default is 25. Use 'all' for all results. (Optional)
var_sort <-  # List[str] | Fields to sort results by. Prefix with '-' for descending order. Can be repeated for multiple sort fields. Does not work with limit=all. (Optional)
var_id <-  # List[str] | Filter by @id (Optional)
var_access_key_id <-  # List[str] | Filter by access_key_id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_secret_access_key_hash <-  # List[str] | Filter by secret_access_key_hash (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_user <-  # List[str] | Filter by user (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_sort <-  # List[str] | Fields to sort results by. Prefix with '-' for descending order. Can be repeated for multiple sort fields. Does not work with limit=all. (Optional)
var_id <-  # List[str] | Filter by @id (Optional)
var_accession <-  # List[str] | Filter by accession (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_analysis_step_version <-  # List[str] | Filter by analysis_step_version (Optional)
var_anvil_url <-  # List[str] | Filter by anvil_url (Optional)
var_assembly <-  # List[str] | Filter by assembly (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_content_md5sum <-  # List[str] | Filter by content_md5sum (Optional)
var_content_summary <-  # List[str] | Filter by content_summary (Optional)
var_content_type <-  # List[str] | Filter by content_type (Optional)
var_controlled_access <-  # List[bool] | Filter by controlled_access (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_derived_from <-  # List[str] | Filter by derived_from (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_file_format <-  # List[str] | Filter by file_format (Optional)
var_file_format_specifications <-  # List[str] | Filter by file_format_specifications (Optional)
var_file_set <-  # List[str] | Filter by file_set (Optional)
var_file_size <-  # List[int] | Filter by file_size (Optional)
var_filtered <-  # List[bool] | Filter by filtered (Optional)
var_gene_list_for <-  # List[str] | Filter by gene_list_for (Optional)
var_href <-  # List[str] | Filter by href (Optional)
var_input_file_for <-  # List[str] | Filter by input_file_for (Optional)
var_integrated_in <-  # List[str] | Filter by integrated_in (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_loci_list_for <-  # List[str] | Filter by loci_list_for (Optional)
var_md5sum <-  # List[str] | Filter by md5sum (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_redacted <-  # List[bool] | Filter by redacted (Optional)
var_reference_files <-  # List[str] | Filter by reference_files (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_s3_uri <-  # List[str] | Filter by s3_uri (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_file_name <-  # List[str] | Filter by submitted_file_name (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_transcriptome_annotation <-  # List[str] | Filter by transcriptome_annotation (Optional)
var_upload_status <-  # List[str] | Filter by upload_status (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_validation_error_detail <-  # List[str] | Filter by validation_error_detail (Optional)
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_assay_titles <-  # List[str] | Filter by assay_titles (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_award_contact_pi_id <-  # List[str] | Filter by award.contact_pi.@id (Optional)
var_award_contact_pi_title <-  # List[str] | Filter by award.contact_pi.title (Optional)
var_award_title <-  # List[str] | Filter by award.title (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_control_for_id <-  # List[str] | Filter by control_for.@id (Optional)
var_control_for_accession <-  # List[str] | Filter by control_for.accession (Optional)
var_control_for_aliases <-  # List[str] | Filter by control_for.aliases (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_donors_id <-  # List[str] | Filter by donors.@id (Optional)
var_donors_accession <-  # List[str] | Filter by donors.accession (Optional)
var_donors_aliases <-  # List[str] | Filter by donors.aliases (Optional)
var_donors_sex <-  # List[str] | Filter by donors.sex (Optional)
var_donors_status <-  # List[str] | Filter by donors.status (Optional)
var_donors_taxa <-  # List[str] | Filter by donors.taxa (Optional)
var_file_set_type <-  # List[str] | Filter by file_set_type (Optional)
var_files_id <-  # List[str] | Filter by files.@id (Optional)
var_files_accession <-  # List[str] | Filter by files.accession (Optional)
var_files_aliases <-  # List[str] | Filter by files.aliases (Optional)
var_files_content_type <-  # List[str] | Filter by files.content_type (Optional)
var_files_creation_timestamp <-  # List[str] | Filter by files.creation_timestamp (Optional)
var_files_file_format <-  # List[str] | Filter by files.file_format (Optional)
var_files_file_size <-  # List[int] | Filter by files.file_size (Optional)
var_files_href <-  # List[str] | Filter by files.href (Optional)
var_files_s3_uri <-  # List[str] | Filter by files.s3_uri (Optional)
var_files_sequencing_platform <-  # List[str] | Filter by files.sequencing_platform (Optional)
var_files_submitted_file_name <-  # List[str] | Filter by files.submitted_file_name (Optional)
var_files_upload_status <-  # List[str] | Filter by files.upload_status (Optional)
var_input_file_set_for <-  # List[str] | Filter by input_file_set_for (Optional)
var_input_file_sets_id <-  # List[str] | Filter by input_file_sets.@id (Optional)
var_input_file_sets_accession <-  # List[str] | Filter by input_file_sets.accession (Optional)
var_input_file_sets_aliases <-  # List[str] | Filter by input_file_sets.aliases (Optional)
var_input_file_sets_file_set_type <-  # List[str] | Filter by input_file_sets.file_set_type (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_samples_id <-  # List[str] | Filter by samples.@id (Optional)
var_samples_accession <-  # List[str] | Filter by samples.accession (Optional)
var_samples_aliases <-  # List[str] | Filter by samples.aliases (Optional)
var_samples_cell_fate_change_treatments <-  # List[str] | Filter by samples.cell_fate_change_treatments (Optional)
var_samples_classifications <-  # List[str] | Filter by samples.classifications (Optional)
var_samples_construct_library_sets <-  # List[str] | Filter by samples.construct_library_sets (Optional)
var_samples_disease_terms_id <-  # List[str] | Filter by samples.disease_terms.@id (Optional)
var_samples_disease_terms_term_name <-  # List[str] | Filter by samples.disease_terms.term_name (Optional)
var_samples_modifications <-  # List[str] | Filter by samples.modifications (Optional)
var_samples_sample_terms_id <-  # List[str] | Filter by samples.sample_terms.@id (Optional)
var_samples_sample_terms_aliases <-  # List[str] | Filter by samples.sample_terms.aliases (Optional)
var_samples_sample_terms_status <-  # List[str] | Filter by samples.sample_terms.status (Optional)
var_samples_sample_terms_summary <-  # List[str] | Filter by samples.sample_terms.summary (Optional)
var_samples_sample_terms_term_name <-  # List[str] | Filter by samples.sample_terms.term_name (Optional)
var_samples_status <-  # List[str] | Filter by samples.status (Optional)
var_samples_summary <-  # List[str] | Filter by samples.summary (Optional)
var_samples_targeted_sample_term_id <-  # List[str] | Filter by samples.targeted_sample_term.@id (Optional)
var_samples_targeted_sample_term_term_name <-  # List[str] | Filter by samples.targeted_sample_term.term_name (Optional)
var_samples_taxa <-  # List[str] | Filter by samples.taxa (Optional)
var_samples_treatments <-  # List[str] | Filter by samples.treatments (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_files_timestamp <-  # List[str] | Filter by submitted_files_timestamp (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_analysis_step_id <-  # List[str] | Filter by analysis_step.@id (Optional)
var_analysis_step_name <-  # List[str] | Filter by analysis_step.name (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
...
var_notes <-  # List[str] | Filter by notes (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_software_versions_id <-  # List[str] | Filter by software_versions.@id (Optional)
var_software_versions_name <-  # List[str] | Filter by software_versions.name (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_analysis_step_types <-  # List[str] | Filter by analysis_step_types (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_input_content_types <-  # List[str] | Filter by input_content_types (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_output_content_types <-  # List[str] | Filter by output_content_types (Optional)
var_parents_id <-  # List[str] | Filter by parents.@id (Optional)
var_parents_title <-  # List[str] | Filter by parents.title (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_step_label <-  # List[str] | Filter by step_label (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_title <-  # List[str] | Filter by title (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_workflow_id <-  # List[str] | Filter by workflow.@id (Optional)
var_workflow_accession <-  # List[str] | Filter by workflow.accession (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_ancestors <-  # List[str] | Filter by ancestors (Optional)
var_assay_slims <-  # List[str] | Filter by assay_slims (Optional)
var_category_slims <-  # List[str] | Filter by category_slims (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_deprecated_ntr_terms <-  # List[str] | Filter by deprecated_ntr_terms (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_is_a <-  # List[str] | Filter by is_a (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_objective_slims <-  # List[str] | Filter by objective_slims (Optional)
var_ontology <-  # List[str] | Filter by ontology (Optional)
var_preferred_assay_titles <-  # List[str] | Filter by preferred_assay_titles (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_synonyms <-  # List[str] | Filter by synonyms (Optional)
var_term_id <-  # List[str] | Filter by term_id (Optional)
var_term_name <-  # List[str] | Filter by term_name (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_measurement_sets_id <-  # List[str] | Filter by measurement_sets.@id (Optional)
var_measurement_sets_accession <-  # List[str] | Filter by measurement_sets.accession (Optional)
var_measurement_sets_aliases <-  # List[str] | Filter by measurement_sets.aliases (Optional)
var_measurement_sets_preferred_assay_title <-  # List[str] | Filter by measurement_sets.preferred_assay_title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_url <-  # List[str] | Filter by url (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_component <-  # List[str] | Filter by component (Optional)
var_contact_pi <-  # List[str] | Filter by contact_pi (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_end_date <-  # List[str] | Filter by end_date (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_pis <-  # List[str] | Filter by pis (Optional)
var_project <-  # List[str] | Filter by project (Optional)
var_start_date <-  # List[str] | Filter by start_date (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_url <-  # List[str] | Filter by url (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_viewing_group <-  # List[str] | Filter by viewing_group (Optional)
...
# **batch_download**
> str batch_download(type, query = var.query, field_filters = var.field_filters)
...
#
# prepare function argument(s)
var_type <-  # List[str] | Type of objects to return. Can be repeated for multiple types.
var_query <-  # str | Query string for searching. (Optional)
var_field_filters <-  # object | Any field from any object type can be used as a filter. Use '!' for negation, '*' as a wildcard, and 'lt:', 'lte:', 'gt:', 'gte:' for range queries on numeric fields. (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$batch_download(var_type, query = var_query, field_filters = var_field_filtersdata_file = "result.txt")
result <- api_instance$batch_download(var_type, query = var_query, field_filters = var_field_filters)
dput(result)
```
...
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_award_name <-  # List[str] | Filter by award.name (Optional)
var_biomarker_for <-  # List[str] | Filter by biomarker_for (Optional)
var_classification <-  # List[str] | Filter by classification (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_gene <-  # List[str] | Filter by gene (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_name_quantification <-  # List[str] | Filter by name_quantification (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_quantification <-  # List[str] | Filter by quantification (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
...
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_s3_uri <-  # List[str] | Filter by s3_uri (Optional)
var_seqspec_of <-  # List[str] | Filter by seqspec_of (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_file_name <-  # List[str] | Filter by submitted_file_name (Optional)
 ...
 **description** | list( **str** )| Filter by description | [optional] 
 **documents** | list( **str** )| Filter by documents | [optional] 
 **file_format** | Enum [yaml, json] | Filter by file_format | [optional] 
 **file_format_specifications** | list( **str** )| Filter by file_format_specifications | [optional] 
 **file_set** | list( **str** )| Filter by file_set | [optional] 
 **file_size** | list( **int** )| Filter by file_size | [optional] 
 **gene_list_for** | list( **str** )| Filter by gene_list_for | [optional] 
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_applied_to_samples_id <-  # List[str] | Filter by applied_to_samples.@id (Optional)
var_applied_to_samples_accession <-  # List[str] | Filter by applied_to_samples.accession (Optional)
var_applied_to_samples_aliases <-  # List[str] | Filter by applied_to_samples.aliases (Optional)
var_applied_to_samples_disease_terms_id <-  # List[str] | Filter by applied_to_samples.disease_terms.@id (Optional)
var_applied_to_samples_disease_terms_term_name <-  # List[str] | Filter by applied_to_samples.disease_terms.term_name (Optional)
var_applied_to_samples_sample_terms_id <-  # List[str] | Filter by applied_to_samples.sample_terms.@id (Optional)
var_applied_to_samples_sample_terms_term_name <-  # List[str] | Filter by applied_to_samples.sample_terms.term_name (Optional)
var_applied_to_samples_status <-  # List[str] | Filter by applied_to_samples.status (Optional)
var_applied_to_samples_summary <-  # List[str] | Filter by applied_to_samples.summary (Optional)
var_associated_phenotypes_id <-  # List[str] | Filter by associated_phenotypes.@id (Optional)
var_associated_phenotypes_term_id <-  # List[str] | Filter by associated_phenotypes.term_id (Optional)
var_associated_phenotypes_term_name <-  # List[str] | Filter by associated_phenotypes.term_name (Optional)
var_average_guide_coverage <-  # List[float] | Filter by average_guide_coverage (Optional)
var_average_insert_size <-  # List[float] | Filter by average_insert_size (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_control_for_id <-  # List[str] | Filter by control_for.@id (Optional)
...
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_exon <-  # List[str] | Filter by exon (Optional)
var_file_set_type <-  # List[str] | Filter by file_set_type (Optional)
var_files_id <-  # List[str] | Filter by files.@id (Optional)
var_files_accession <-  # List[str] | Filter by files.accession (Optional)
var_files_aliases <-  # List[str] | Filter by files.aliases (Optional)
...
var_files_file_format <-  # List[str] | Filter by files.file_format (Optional)
var_files_upload_status <-  # List[str] | Filter by files.upload_status (Optional)
var_guide_type <-  # List[str] | Filter by guide_type (Optional)
var_input_file_set_for <-  # List[str] | Filter by input_file_set_for (Optional)
var_integrated_content_files <-  # List[str] | Filter by integrated_content_files (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_large_scale_gene_list_id <-  # List[str] | Filter by large_scale_gene_list.@id (Optional)
var_large_scale_gene_list_accession <-  # List[str] | Filter by large_scale_gene_list.accession (Optional)
var_large_scale_gene_list_aliases <-  # List[str] | Filter by large_scale_gene_list.aliases (Optional)
var_large_scale_loci_list_id <-  # List[str] | Filter by large_scale_loci_list.@id (Optional)
var_large_scale_loci_list_accession <-  # List[str] | Filter by large_scale_loci_list.accession (Optional)
var_large_scale_loci_list_aliases <-  # List[str] | Filter by large_scale_loci_list.aliases (Optional)
var_lot_id <-  # List[str] | Filter by lot_id (Optional)
var_lower_bound_guide_coverage <-  # List[int] | Filter by lower_bound_guide_coverage (Optional)
var_lower_bound_insert_size <-  # List[int] | Filter by lower_bound_insert_size (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_orf_list_id <-  # List[str] | Filter by orf_list.@id (Optional)
var_orf_list_aliases <-  # List[str] | Filter by orf_list.aliases (Optional)
var_orf_list_gene <-  # List[str] | Filter by orf_list.gene (Optional)
var_orf_list_orf_id <-  # List[str] | Filter by orf_list.orf_id (Optional)
var_product_id <-  # List[str] | Filter by product_id (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_scope <-  # List[str] | Filter by scope (Optional)
var_selection_criteria <-  # List[str] | Filter by selection_criteria (Optional)
var_small_scale_gene_list_id <-  # List[str] | Filter by small_scale_gene_list.@id (Optional)
var_small_scale_gene_list_geneid <-  # List[str] | Filter by small_scale_gene_list.geneid (Optional)
var_small_scale_gene_list_name <-  # List[str] | Filter by small_scale_gene_list.name (Optional)
var_small_scale_gene_list_symbol <-  # List[str] | Filter by small_scale_gene_list.symbol (Optional)
var_small_scale_gene_list_synonyms <-  # List[str] | Filter by small_scale_gene_list.synonyms (Optional)
var_small_scale_loci_list <-  # List[Locus] | Filter by small_scale_loci_list (Optional)
var_sources <-  # List[str] | Filter by sources (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_files_timestamp <-  # List[str] | Filter by submitted_files_timestamp (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_targeton <-  # List[str] | Filter by targeton (Optional)
var_tiling_modality <-  # List[str] | Filter by tiling_modality (Optional)
var_upper_bound_guide_coverage <-  # List[int] | Filter by upper_bound_guide_coverage (Optional)
var_upper_bound_insert_size <-  # List[int] | Filter by upper_bound_insert_size (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_sort <-  # List[str] | Fields to sort results by. Prefix with '-' for descending order. Can be repeated for multiple sort fields. Does not work with limit=all. (Optional)
var_id <-  # List[str] | Filter by @id (Optional)
var_activated <-  # List[bool] | Filter by activated (Optional)
var_activating_agent_term_id <-  # List[str] | Filter by activating_agent_term_id (Optional)
var_activating_agent_term_name <-  # List[str] | Filter by activating_agent_term_name (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_biosamples_modified <-  # List[str] | Filter by biosamples_modified (Optional)
var_cas <-  # List[str] | Filter by cas (Optional)
var_cas_species <-  # List[str] | Filter by cas_species (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_fused_domain <-  # List[str] | Filter by fused_domain (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_lot_id <-  # List[str] | Filter by lot_id (Optional)
var_modality <-  # List[str] | Filter by modality (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_product_id <-  # List[str] | Filter by product_id (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_sources <-  # List[str] | Filter by sources (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_tagged_protein <-  # List[str] | Filter by tagged_protein (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_assemblies <-  # List[str] | Filter by assemblies (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_award_contact_pi_id <-  # List[str] | Filter by award.contact_pi.@id (Optional)
var_award_contact_pi_title <-  # List[str] | Filter by award.contact_pi.title (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_taxa <-  # List[str] | Filter by taxa (Optional)
var_transcriptome_annotations <-  # List[str] | Filter by transcriptome_annotations (Optional)
var_url <-  # List[str] | Filter by url (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_biosamples_modified <-  # List[str] | Filter by biosamples_modified (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_degron_system <-  # List[str] | Filter by degron_system (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_tagged_proteins <-  # List[str] | Filter by tagged_proteins (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_characterization_method <-  # List[str] | Filter by characterization_method (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_document_type <-  # List[str] | Filter by document_type (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_urls <-  # List[str] | Filter by urls (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
#
# prepare function argument(s)
var_file_id <-  # str | The unique identifier for the file to download, e.g. @id (/tabular-files/IGVFFI8092FZKL/), accession (IGVFFI8092FZKL), or UUID (fdbdc159-e5b9-40a8-b788-3f72c9886b03).
...
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_geneid <-  # List[str] | Filter by geneid (Optional)
var_geneid_with_version <-  # List[str] | Filter by geneid_with_version (Optional)
var_locations <-  # List[GeneLocation] | Filter by locations (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_symbol <-  # List[str] | Filter by symbol (Optional)
var_synonyms <-  # List[str] | Filter by synonyms (Optional)
var_taxa <-  # List[str] | Filter by taxa (Optional)
var_title <-  # List[str] | Filter by title (Optional)
var_transcriptome_annotation <-  # List[str] | Filter by transcriptome_annotation (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_version_number <-  # List[str] | Filter by version_number (Optional)
 ...
 **locations** | list( [**GeneLocation**](GeneLocation.md) )| Filter by locations | [optional] 
 **name** | list( **str** )| Filter by name | [optional] 
 **notes** | list( **str** )| Filter by notes | [optional] 
 **release_timestamp** | list( **str** )| Filter by release_timestamp | [optional] 
 **status** | Enum [archived, deleted, in progress, released] | Filter by status | [optional] 
...
var_file_format <-  # List[str] | Filter by file_format (Optional)
var_file_format_specifications <-  # List[str] | Filter by file_format_specifications (Optional)
var_file_format_type <-  # List[str] | Filter by file_format_type (Optional)
var_file_set <-  # List[str] | Filter by file_set (Optional)
var_file_size <-  # List[int] | Filter by file_size (Optional)
var_gene_list_for <-  # List[str] | Filter by gene_list_for (Optional)
var_href <-  # List[str] | Filter by href (Optional)
...
# **get_by_id**
> Item get_by_id(resource_id, frame)
...
#
# prepare function argument(s)
var_resource_id <-  # str | The unique identifier for the resource i.e. @id (`/sequence-files/IGVFFI1165AJSO/`), accession (`IGVFFI1165AJSO`) or UUID (`fffcd64e-af02-4675-8953-7352459ee06a`).
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$get_by_id(var_resource_id, var_framedata_file = "result.txt")
result <- api_instance$get_by_id(var_resource_id, var_frame)
dput(result)
```
...
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_ethnicities <-  # List[str] | Filter by ethnicities (Optional)
var_human_donor_identifiers <-  # List[str] | Filter by human_donor_identifiers (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_phenotypic_features_id <-  # List[str] | Filter by phenotypic_features.@id (Optional)
var_phenotypic_features_feature_id <-  # List[str] | Filter by phenotypic_features.feature.@id (Optional)
var_phenotypic_features_feature_term_id <-  # List[str] | Filter by phenotypic_features.feature.term_id (Optional)
var_phenotypic_features_feature_term_name <-  # List[str] | Filter by phenotypic_features.feature.term_name (Optional)
var_phenotypic_features_observation_date <-  # List[str] | Filter by phenotypic_features.observation_date (Optional)
var_phenotypic_features_quantity_units <-  # List[str] | Filter by phenotypic_features.quantity_units (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_related_donors_donor_id <-  # List[str] | Filter by related_donors.donor.@id (Optional)
var_related_donors_donor_accession <-  # List[str] | Filter by related_donors.donor.accession (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_sex <-  # List[str] | Filter by sex (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_url <-  # List[str] | Filter by url (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_virtual <-  # List[bool] | Filter by virtual (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_caption <-  # List[str] | Filter by caption (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_download_url <-  # List[str] | Filter by download_url (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_thumb_nail <-  # List[str] | Filter by thumb_nail (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_accession <-  # List[str] | Filter by accession (Optional)
var_age <-  # List[str] | Filter by age (Optional)
var_age_units <-  # List[str] | Filter by age_units (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_biomarkers <-  # List[str] | Filter by biomarkers (Optional)
var_cell_fate_change_protocol <-  # List[str] | Filter by cell_fate_change_protocol (Optional)
var_cell_fate_change_treatments_id <-  # List[str] | Filter by cell_fate_change_treatments.@id (Optional)
var_cell_fate_change_treatments_purpose <-  # List[str] | Filter by cell_fate_change_treatments.purpose (Optional)
var_cell_fate_change_treatments_status <-  # List[str] | Filter by cell_fate_change_treatments.status (Optional)
var_cell_fate_change_treatments_summary <-  # List[str] | Filter by cell_fate_change_treatments.summary (Optional)
var_cell_fate_change_treatments_treatment_type <-  # List[str] | Filter by cell_fate_change_treatments.treatment_type (Optional)
var_cellular_sub_pool <-  # List[str] | Filter by cellular_sub_pool (Optional)
var_classifications <-  # List[str] | Filter by classifications (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_construct_library_sets <-  # List[str] | Filter by construct_library_sets (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_date_obtained <-  # List[str] | Filter by date_obtained (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_demultiplexed_from <-  # List[str] | Filter by demultiplexed_from (Optional)
var_demultiplexed_to <-  # List[str] | Filter by demultiplexed_to (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_disease_terms_id <-  # List[str] | Filter by disease_terms.@id (Optional)
var_disease_terms_term_name <-  # List[str] | Filter by disease_terms.term_name (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_donors <-  # List[str] | Filter by donors (Optional)
var_embryonic <-  # List[bool] | Filter by embryonic (Optional)
var_file_sets_id <-  # List[str] | Filter by file_sets.@id (Optional)
var_file_sets_accession <-  # List[str] | Filter by file_sets.accession (Optional)
var_file_sets_aliases <-  # List[str] | Filter by file_sets.aliases (Optional)
var_file_sets_assay_term_term_name <-  # List[str] | Filter by file_sets.assay_term.term_name (Optional)
var_file_sets_lab_title <-  # List[str] | Filter by file_sets.lab.title (Optional)
var_file_sets_status <-  # List[str] | Filter by file_sets.status (Optional)
var_file_sets_summary <-  # List[str] | Filter by file_sets.summary (Optional)
var_growth_medium <-  # List[str] | Filter by growth_medium (Optional)
var_institutional_certificates_id <-  # List[str] | Filter by institutional_certificates.@id (Optional)
var_institutional_certificates_certificate_identifier <-  # List[str] | Filter by institutional_certificates.certificate_identifier (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_lot_id <-  # List[str] | Filter by lot_id (Optional)
var_lower_bound_age <-  # List[float] | Filter by lower_bound_age (Optional)
var_lower_bound_age_in_hours <-  # List[float] | Filter by lower_bound_age_in_hours (Optional)
var_modifications_id <-  # List[str] | Filter by modifications.@id (Optional)
var_modifications_status <-  # List[str] | Filter by modifications.status (Optional)
var_modifications_summary <-  # List[str] | Filter by modifications.summary (Optional)
var_moi <-  # List[float] | Filter by moi (Optional)
var_multiplexed_in_id <-  # List[str] | Filter by multiplexed_in.@id (Optional)
var_multiplexed_in_accession <-  # List[str] | Filter by multiplexed_in.accession (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_nucleic_acid_delivery <-  # List[str] | Filter by nucleic_acid_delivery (Optional)
var_origin_of <-  # List[str] | Filter by origin_of (Optional)
var_originated_from_id <-  # List[str] | Filter by originated_from.@id (Optional)
var_originated_from_accession <-  # List[str] | Filter by originated_from.accession (Optional)
var_part_of <-  # List[str] | Filter by part_of (Optional)
var_parts <-  # List[str] | Filter by parts (Optional)
var_passage_number <-  # List[int] | Filter by passage_number (Optional)
var_pooled_from <-  # List[str] | Filter by pooled_from (Optional)
var_pooled_in <-  # List[str] | Filter by pooled_in (Optional)
var_product_id <-  # List[str] | Filter by product_id (Optional)
var_protocols <-  # List[str] | Filter by protocols (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_sample_terms_id <-  # List[str] | Filter by sample_terms.@id (Optional)
var_sample_terms_term_name <-  # List[str] | Filter by sample_terms.term_name (Optional)
var_sex <-  # List[str] | Filter by sex (Optional)
var_sorted_fractions <-  # List[str] | Filter by sorted_fractions (Optional)
var_sorted_from_id <-  # List[str] | Filter by sorted_from.@id (Optional)
var_sorted_from_accession <-  # List[str] | Filter by sorted_from.accession (Optional)
var_sorted_from_detail <-  # List[str] | Filter by sorted_from_detail (Optional)
var_sources_id <-  # List[str] | Filter by sources.@id (Optional)
var_starting_amount <-  # List[float] | Filter by starting_amount (Optional)
var_starting_amount_units <-  # List[str] | Filter by starting_amount_units (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_targeted_sample_term <-  # List[str] | Filter by targeted_sample_term (Optional)
var_taxa <-  # List[str] | Filter by taxa (Optional)
var_time_post_change <-  # List[float] | Filter by time_post_change (Optional)
var_time_post_change_units <-  # List[str] | Filter by time_post_change_units (Optional)
var_time_post_library_delivery <-  # List[float] | Filter by time_post_library_delivery (Optional)
var_time_post_library_delivery_units <-  # List[str] | Filter by time_post_library_delivery_units (Optional)
var_treatments_id <-  # List[str] | Filter by treatments.@id (Optional)
var_treatments_purpose <-  # List[str] | Filter by treatments.purpose (Optional)
var_treatments_status <-  # List[str] | Filter by treatments.status (Optional)
var_treatments_summary <-  # List[str] | Filter by treatments.summary (Optional)
var_treatments_treatment_type <-  # List[str] | Filter by treatments.treatment_type (Optional)
var_upper_bound_age <-  # List[float] | Filter by upper_bound_age (Optional)
var_upper_bound_age_in_hours <-  # List[float] | Filter by upper_bound_age_in_hours (Optional)
var_url <-  # List[str] | Filter by url (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_virtual <-  # List[bool] | Filter by virtual (Optional)
...
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_certificate_identifier <-  # List[str] | Filter by certificate_identifier (Optional)
var_controlled_access <-  # List[bool] | Filter by controlled_access (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_data_use_limitation <-  # List[str] | Filter by data_use_limitation (Optional)
var_data_use_limitation_modifiers <-  # List[str] | Filter by data_use_limitation_modifiers (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_samples <-  # List[str] | Filter by samples (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$institutional_certificates(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, aliases = var_aliases, award_id = var_award_id, award_component = var_award_component, certificate_identifier = var_certificate_identifier, controlled_access = var_controlled_access, creation_timestamp = var_creation_timestamp, data_use_limitation = var_data_use_limitation, data_use_limitation_modifiers = var_data_use_limitation_modifiers, description = var_description, lab_id = var_lab_id, lab_title = var_lab_title, notes = var_notes, release_timestamp = var_release_timestamp, samples = var_samples, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, urls = var_urls, uuid = var_uuiddata_file = "result.txt")
result <- api_instance$institutional_certificates(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, aliases = var_aliases, award_id = var_award_id, award_component = var_award_component, certificate_identifier = var_certificate_identifier, controlled_access = var_controlled_access, creation_timestamp = var_creation_timestamp, data_use_limitation = var_data_use_limitation, data_use_limitation_modifiers = var_data_use_limitation_modifiers, description = var_description, lab_id = var_lab_id, lab_title = var_lab_title, notes = var_notes, release_timestamp = var_release_timestamp, samples = var_samples, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, urls = var_urls, uuid = var_uuid)
dput(result)
```
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_awards_id <-  # List[str] | Filter by awards.@id (Optional)
var_awards_component <-  # List[str] | Filter by awards.component (Optional)
var_awards_name <-  # List[str] | Filter by awards.name (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_institute_label <-  # List[str] | Filter by institute_label (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_pi <-  # List[str] | Filter by pi (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_derived_from <-  # List[str] | Filter by derived_from (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_dimension1 <-  # List[str] | Filter by dimension1 (Optional)
var_dimension2 <-  # List[str] | Filter by dimension2 (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_file_format <-  # List[str] | Filter by file_format (Optional)
var_file_format_specifications <-  # List[str] | Filter by file_format_specifications (Optional)
var_file_set <-  # List[str] | Filter by file_set (Optional)
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_assay_term_id <-  # List[str] | Filter by assay_term.@id (Optional)
var_assay_term_term_name <-  # List[str] | Filter by assay_term.term_name (Optional)
var_auxiliary_sets_id <-  # List[str] | Filter by auxiliary_sets.@id (Optional)
var_auxiliary_sets_accession <-  # List[str] | Filter by auxiliary_sets.accession (Optional)
var_auxiliary_sets_aliases <-  # List[str] | Filter by auxiliary_sets.aliases (Optional)
var_auxiliary_sets_file_set_type <-  # List[str] | Filter by auxiliary_sets.file_set_type (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_award_contact_pi_id <-  # List[str] | Filter by award.contact_pi.@id (Optional)
var_award_contact_pi_title <-  # List[str] | Filter by award.contact_pi.title (Optional)
var_award_title <-  # List[str] | Filter by award.title (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_control_file_sets_id <-  # List[str] | Filter by control_file_sets.@id (Optional)
var_control_file_sets_accession <-  # List[str] | Filter by control_file_sets.accession (Optional)
var_control_file_sets_aliases <-  # List[str] | Filter by control_file_sets.aliases (Optional)
var_control_for_id <-  # List[str] | Filter by control_for.@id (Optional)
var_control_for_accession <-  # List[str] | Filter by control_for.accession (Optional)
var_control_for_aliases <-  # List[str] | Filter by control_for.aliases (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
...
var_donors_status <-  # List[str] | Filter by donors.status (Optional)
var_donors_taxa <-  # List[str] | Filter by donors.taxa (Optional)
var_external_image_url <-  # List[str] | Filter by external_image_url (Optional)
var_file_set_type <-  # List[str] | Filter by file_set_type (Optional)
var_files_id <-  # List[str] | Filter by files.@id (Optional)
var_files_accession <-  # List[str] | Filter by files.accession (Optional)
var_files_aliases <-  # List[str] | Filter by files.aliases (Optional)
...
var_files_href <-  # List[str] | Filter by files.href (Optional)
var_files_s3_uri <-  # List[str] | Filter by files.s3_uri (Optional)
var_files_sequencing_platform_id <-  # List[str] | Filter by files.sequencing_platform.@id (Optional)
var_files_sequencing_platform_term_name <-  # List[str] | Filter by files.sequencing_platform.term_name (Optional)
var_files_submitted_file_name <-  # List[str] | Filter by files.submitted_file_name (Optional)
var_files_upload_status <-  # List[str] | Filter by files.upload_status (Optional)
var_input_file_set_for <-  # List[str] | Filter by input_file_set_for (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_multiome_size <-  # List[int] | Filter by multiome_size (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_preferred_assay_title <-  # List[str] | Filter by preferred_assay_title (Optional)
var_protocols <-  # List[str] | Filter by protocols (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_related_multiome_datasets_id <-  # List[str] | Filter by related_multiome_datasets.@id (Optional)
var_related_multiome_datasets_accession <-  # List[str] | Filter by related_multiome_datasets.accession (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_samples_id <-  # List[str] | Filter by samples.@id (Optional)
var_samples_accession <-  # List[str] | Filter by samples.accession (Optional)
var_samples_aliases <-  # List[str] | Filter by samples.aliases (Optional)
var_samples_cell_fate_change_treatments_id <-  # List[str] | Filter by samples.cell_fate_change_treatments.@id (Optional)
var_samples_cell_fate_change_treatments_purpose <-  # List[str] | Filter by samples.cell_fate_change_treatments.purpose (Optional)
var_samples_cell_fate_change_treatments_summary <-  # List[str] | Filter by samples.cell_fate_change_treatments.summary (Optional)
var_samples_cell_fate_change_treatments_treatment_type <-  # List[str] | Filter by samples.cell_fate_change_treatments.treatment_type (Optional)
var_samples_classifications <-  # List[str] | Filter by samples.classifications (Optional)
var_samples_construct_library_sets_id <-  # List[str] | Filter by samples.construct_library_sets.@id (Optional)
var_samples_construct_library_sets_accession <-  # List[str] | Filter by samples.construct_library_sets.accession (Optional)
var_samples_construct_library_sets_file_set_type <-  # List[str] | Filter by samples.construct_library_sets.file_set_type (Optional)
var_samples_construct_library_sets_small_scale_gene_list_id <-  # List[str] | Filter by samples.construct_library_sets.small_scale_gene_list.@id (Optional)
var_samples_construct_library_sets_small_scale_gene_list_geneid <-  # List[str] | Filter by samples.construct_library_sets.small_scale_gene_list.geneid (Optional)
var_samples_construct_library_sets_small_scale_gene_list_name <-  # List[str] | Filter by samples.construct_library_sets.small_scale_gene_list.name (Optional)
var_samples_construct_library_sets_small_scale_gene_list_summary <-  # List[str] | Filter by samples.construct_library_sets.small_scale_gene_list.summary (Optional)
var_samples_construct_library_sets_small_scale_gene_list_symbol <-  # List[str] | Filter by samples.construct_library_sets.small_scale_gene_list.symbol (Optional)
var_samples_construct_library_sets_summary <-  # List[str] | Filter by samples.construct_library_sets.summary (Optional)
var_samples_disease_terms_id <-  # List[str] | Filter by samples.disease_terms.@id (Optional)
var_samples_disease_terms_term_name <-  # List[str] | Filter by samples.disease_terms.term_name (Optional)
var_samples_modifications_id <-  # List[str] | Filter by samples.modifications.@id (Optional)
var_samples_sample_terms_id <-  # List[str] | Filter by samples.sample_terms.@id (Optional)
var_samples_sample_terms_aliases <-  # List[str] | Filter by samples.sample_terms.aliases (Optional)
var_samples_sample_terms_status <-  # List[str] | Filter by samples.sample_terms.status (Optional)
var_samples_sample_terms_summary <-  # List[str] | Filter by samples.sample_terms.summary (Optional)
...
var_samples_targeted_sample_term_term_name <-  # List[str] | Filter by samples.targeted_sample_term.term_name (Optional)
var_samples_taxa <-  # List[str] | Filter by samples.taxa (Optional)
var_samples_treatments_id <-  # List[str] | Filter by samples.treatments.@id (Optional)
var_samples_treatments_purpose <-  # List[str] | Filter by samples.treatments.purpose (Optional)
var_samples_treatments_summary <-  # List[str] | Filter by samples.treatments.summary (Optional)
var_samples_treatments_treatment_type <-  # List[str] | Filter by samples.treatments.treatment_type (Optional)
var_sequencing_library_types <-  # List[str] | Filter by sequencing_library_types (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_files_timestamp <-  # List[str] | Filter by submitted_files_timestamp (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_targeted_genes_id <-  # List[str] | Filter by targeted_genes.@id (Optional)
var_targeted_genes_geneid <-  # List[str] | Filter by targeted_genes.geneid (Optional)
var_targeted_genes_name <-  # List[str] | Filter by targeted_genes.name (Optional)
var_targeted_genes_symbol <-  # List[str] | Filter by targeted_genes.symbol (Optional)
var_targeted_genes_synonyms <-  # List[str] | Filter by targeted_genes.synonyms (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
 ...
 **notes** | list( **str** )| Filter by notes | [optional] 
 **preferred_assay_title** | Enum [10x multiome, 10x multiome with MULTI-seq, AAV-MPRA, ATAC-seq, CERES-seq, Cell painting, CRISPR FlowFISH, DOGMA-seq, Histone ChIP-seq, Hi-C, HT-recruit, lentiMPRA, MERFISH, MIAA, mN2H, MPRA, MPRA (scQer), MULTI-seq, Parse SPLiT-seq, Perturb-seq, RNA-seq, SGE, scATAC-seq, scNT-seq, scNT-seq2, scRNA-seq, semi-qY2H, SHARE-seq, smFISH, snATAC-seq, snmC-Seq2, snMCT-seq, snM3C-seq, snRNA-seq, Spatial transcriptomics, SUPERSTARR, TAP-seq, TF ChIP-seq, VAMP-seq, Variant FlowFISH, Variant painting, Y2H, yN2H] | Filter by preferred_assay_title | [optional] 
 **protocols** | list( **str** )| Filter by protocols | [optional] 
 **publications_id** | list( **str** )| Filter by publications.@id | [optional] 
 **publications_publication_identifiers** | list( **str** )| Filter by publications.publication_identifiers | [optional] 
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_assessed_genes <-  # List[str] | Filter by assessed_genes (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_award_contact_pi_id <-  # List[str] | Filter by award.contact_pi.@id (Optional)
var_award_contact_pi_title <-  # List[str] | Filter by award.contact_pi.title (Optional)
...
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_model_name <-  # List[str] | Filter by model_name (Optional)
var_model_version <-  # List[str] | Filter by model_version (Optional)
var_model_zoo_location <-  # List[str] | Filter by model_zoo_location (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_prediction_objects <-  # List[str] | Filter by prediction_objects (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
...
var_samples_taxa <-  # List[str] | Filter by samples.taxa (Optional)
var_samples_treatments <-  # List[str] | Filter by samples.treatments (Optional)
var_software_version <-  # List[str] | Filter by software_version (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_files_timestamp <-  # List[str] | Filter by submitted_files_timestamp (Optional)
...
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_barcode_sample_map <-  # List[str] | Filter by barcode_sample_map (Optional)
var_biomarkers <-  # List[str] | Filter by biomarkers (Optional)
var_cellular_sub_pool <-  # List[str] | Filter by cellular_sub_pool (Optional)
var_classifications <-  # List[str] | Filter by classifications (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_construct_library_sets_id <-  # List[str] | Filter by construct_library_sets.@id (Optional)
var_construct_library_sets_accession <-  # List[str] | Filter by construct_library_sets.accession (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_date_obtained <-  # List[str] | Filter by date_obtained (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_description <-  # List[str] | Filter by description (Optional)
...
var_file_sets_status <-  # List[str] | Filter by file_sets.status (Optional)
var_file_sets_summary <-  # List[str] | Filter by file_sets.summary (Optional)
var_institutional_certificates <-  # List[str] | Filter by institutional_certificates (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_modifications_id <-  # List[str] | Filter by modifications.@id (Optional)
var_modifications_status <-  # List[str] | Filter by modifications.status (Optional)
...
var_multiplexed_in_id <-  # List[str] | Filter by multiplexed_in.@id (Optional)
var_multiplexed_in_accession <-  # List[str] | Filter by multiplexed_in.accession (Optional)
var_multiplexed_samples_id <-  # List[str] | Filter by multiplexed_samples.@id (Optional)
var_multiplexed_samples_accession <-  # List[str] | Filter by multiplexed_samples.accession (Optional)
var_multiplexed_samples_construct_library_sets <-  # List[str] | Filter by multiplexed_samples.construct_library_sets (Optional)
var_multiplexed_samples_disease_terms_id <-  # List[str] | Filter by multiplexed_samples.disease_terms.@id (Optional)
var_multiplexed_samples_disease_terms_term_name <-  # List[str] | Filter by multiplexed_samples.disease_terms.term_name (Optional)
var_multiplexed_samples_donors_id <-  # List[str] | Filter by multiplexed_samples.donors.@id (Optional)
var_multiplexed_samples_donors_accession <-  # List[str] | Filter by multiplexed_samples.donors.accession (Optional)
var_multiplexed_samples_sample_terms_id <-  # List[str] | Filter by multiplexed_samples.sample_terms.@id (Optional)
var_multiplexed_samples_sample_terms_term_name <-  # List[str] | Filter by multiplexed_samples.sample_terms.term_name (Optional)
var_multiplexed_samples_status <-  # List[str] | Filter by multiplexed_samples.status (Optional)
var_multiplexed_samples_summary <-  # List[str] | Filter by multiplexed_samples.summary (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_nucleic_acid_delivery <-  # List[str] | Filter by nucleic_acid_delivery (Optional)
var_origin_of <-  # List[str] | Filter by origin_of (Optional)
var_protocols <-  # List[str] | Filter by protocols (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_award <-  # List[str] | Filter by award (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_gene_id <-  # List[str] | Filter by gene.@id (Optional)
var_gene_geneid <-  # List[str] | Filter by gene.geneid (Optional)
var_gene_symbol <-  # List[str] | Filter by gene.symbol (Optional)
var_lab <-  # List[str] | Filter by lab (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_orf_id <-  # List[str] | Filter by orf_id (Optional)
var_pct_coverage_orf <-  # List[float] | Filter by pct_coverage_orf (Optional)
var_pct_coverage_protein <-  # List[float] | Filter by pct_coverage_protein (Optional)
var_pct_identical_protein <-  # List[float] | Filter by pct_identical_protein (Optional)
var_protein_id <-  # List[str] | Filter by protein_id (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by <-  # List[str] | Filter by submitted_by (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_award <-  # List[str] | Filter by award (Optional)
var_canonical_uri <-  # List[str] | Filter by canonical_uri (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_lab <-  # List[str] | Filter by lab (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_parent <-  # List[str] | Filter by parent (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
...
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_feature_id <-  # List[str] | Filter by feature.@id (Optional)
var_feature_term_id <-  # List[str] | Filter by feature.term_id (Optional)
var_feature_term_name <-  # List[str] | Filter by feature.term_name (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_observation_date <-  # List[str] | Filter by observation_date (Optional)
var_quantity <-  # List[float] | Filter by quantity (Optional)
var_quantity_units <-  # List[str] | Filter by quantity_units (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_ancestors <-  # List[str] | Filter by ancestors (Optional)
var_company <-  # List[str] | Filter by company (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_deprecated_ntr_terms <-  # List[str] | Filter by deprecated_ntr_terms (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_is_a <-  # List[str] | Filter by is_a (Optional)
...
var_ontology <-  # List[str] | Filter by ontology (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_sequencing_kits <-  # List[str] | Filter by sequencing_kits (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_files_upload_status <-  # List[str] | Filter by files.upload_status (Optional)
var_input_file_set_for <-  # List[str] | Filter by input_file_set_for (Optional)
var_input_file_sets <-  # List[str] | Filter by input_file_sets (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_large_scale_gene_list_id <-  # List[str] | Filter by large_scale_gene_list.@id (Optional)
var_large_scale_gene_list_accession <-  # List[str] | Filter by large_scale_gene_list.accession (Optional)
...
var_nucleic_acid_delivery <-  # List[str] | Filter by nucleic_acid_delivery (Optional)
var_origin_of <-  # List[str] | Filter by origin_of (Optional)
var_originated_from <-  # List[str] | Filter by originated_from (Optional)
var_part_of <-  # List[str] | Filter by part_of (Optional)
var_parts <-  # List[str] | Filter by parts (Optional)
var_passage_number <-  # List[int] | Filter by passage_number (Optional)
var_pooled_from <-  # List[str] | Filter by pooled_from (Optional)
...
var_sort <-  # List[str] | Fields to sort results by. Prefix with '-' for descending order. Can be repeated for multiple sort fields. Does not work with limit=all. (Optional)
var_id <-  # List[str] | Filter by @id (Optional)
var_abstract <-  # List[str] | Filter by abstract (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_authors <-  # List[str] | Filter by authors (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_date_published <-  # List[str] | Filter by date_published (Optional)
var_date_revised <-  # List[str] | Filter by date_revised (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_donors <-  # List[str] | Filter by donors (Optional)
var_file_sets <-  # List[str] | Filter by file_sets (Optional)
var_issue <-  # List[str] | Filter by issue (Optional)
var_journal <-  # List[str] | Filter by journal (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_page <-  # List[str] | Filter by page (Optional)
var_publication_identifiers <-  # List[str] | Filter by publication_identifiers (Optional)
var_publication_year <-  # List[int] | Filter by publication_year (Optional)
var_published_by <-  # List[str] | Filter by published_by (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_samples <-  # List[str] | Filter by samples (Optional)
var_software <-  # List[str] | Filter by software (Optional)
var_software_versions <-  # List[str] | Filter by software_versions (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_title <-  # List[str] | Filter by title (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_volume <-  # List[str] | Filter by volume (Optional)
var_workflows <-  # List[str] | Filter by workflows (Optional)
...
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_external <-  # List[bool] | Filter by external (Optional)
var_external_id <-  # List[str] | Filter by external_id (Optional)
var_file_format <-  # List[str] | Filter by file_format (Optional)
var_file_format_specifications <-  # List[str] | Filter by file_format_specifications (Optional)
var_file_format_type <-  # List[str] | Filter by file_format_type (Optional)
var_file_set <-  # List[str] | Filter by file_set (Optional)
...
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_s3_uri <-  # List[str] | Filter by s3_uri (Optional)
var_source_url <-  # List[str] | Filter by source_url (Optional)
var_sources <-  # List[str] | Filter by sources (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
...
# **report**
> str report(query = var.query, type = var.type, limit = var.limit, sort = var.sort, field_filters = var.field_filters, include_fields = var.include_fields, frame = var.frame)
...
# prepare function argument(s)
var_query <-  # str | Query string for searching. (Optional)
var_type <-  # List[str] | Filter by item type. (Optional)
var_limit <-  # Limit | Maximum number of results to return. Default is 25. Use 'all' for all results. (Optional)
var_sort <-  # List[str] | Fields to sort results by. Prefix with '-' for descending order. Does not work with limit=all. (Optional)
var_field_filters <-  # object | Any field from any item type can be used as a filter. Use '!' at end of field name for negation and 'lt:', 'lte:', 'gt:', 'gte:' with value for range queries on numeric fields. Examples: {'status!': 'in progress', 'file_size': 'gte:30000'} (Optional)
var_include_fields <-  # List[str] | Fields to include in the response. Can be repeated for multiple fields. (Optional)
var_frame <-  # str | Object with links, or object with some links embedded. (Optional)
...
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_genotype <-  # List[str] | Filter by genotype (Optional)
var_individual_rodent <-  # List[bool] | Filter by individual_rodent (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_lot_id <-  # List[str] | Filter by lot_id (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
...
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_rodent_identifier <-  # List[str] | Filter by rodent_identifier (Optional)
var_sex <-  # List[str] | Filter by sex (Optional)
var_sources_id <-  # List[str] | Filter by sources.@id (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_strain <-  # List[str] | Filter by strain (Optional)
var_strain_background <-  # List[str] | Filter by strain_background (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$rodent_donors(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, award_id = var_award_id, award_component = var_award_component, collections = var_collections, creation_timestamp = var_creation_timestamp, dbxrefs = var_dbxrefs, description = var_description, documents = var_documents, genotype = var_genotype, individual_rodent = var_individual_rodent, lab_id = var_lab_id, lab_title = var_lab_title, lot_id = var_lot_id, notes = var_notes, phenotypic_features_id = var_phenotypic_features_id, phenotypic_features_feature_id = var_phenotypic_features_feature_id, phenotypic_features_feature_term_id = var_phenotypic_features_feature_term_id, phenotypic_features_feature_term_name = var_phenotypic_features_feature_term_name, phenotypic_features_observation_date = var_phenotypic_features_observation_date, phenotypic_features_quantity_units = var_phenotypic_features_quantity_units, product_id = var_product_id, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, rodent_identifier = var_rodent_identifier, sex = var_sex, sources_id = var_sources_id, status = var_status, strain = var_strain, strain_background = var_strain_background, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, taxa = var_taxa, url = var_url, uuid = var_uuid, virtual = var_virtualdata_file = "result.txt")
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_ancestors <-  # List[str] | Filter by ancestors (Optional)
var_cell_slims <-  # List[str] | Filter by cell_slims (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_dbxrefs <-  # List[str] | Filter by dbxrefs (Optional)
var_deprecated_ntr_terms <-  # List[str] | Filter by deprecated_ntr_terms (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_developmental_slims <-  # List[str] | Filter by developmental_slims (Optional)
var_is_a <-  # List[str] | Filter by is_a (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_ontology <-  # List[str] | Filter by ontology (Optional)
var_organ_slims <-  # List[str] | Filter by organ_slims (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
...
var_summary <-  # List[str] | Filter by summary (Optional)
var_synonyms <-  # List[str] | Filter by synonyms (Optional)
var_system_slims <-  # List[str] | Filter by system_slims (Optional)
var_term_id <-  # List[str] | Filter by term_id (Optional)
var_term_name <-  # List[str] | Filter by term_name (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
#
# prepare function argument(s)
var_item_type <-  # ItemType | The name of the item type
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$schema_for_item_type(var_item_typedata_file = "result.txt")
result <- api_instance$schema_for_item_type(var_item_type)
dput(result)
```
...
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_base_modifications <-  # List[str] | Filter by base_modifications (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_content_md5sum <-  # List[str] | Filter by content_md5sum (Optional)
var_content_type <-  # List[str] | Filter by content_type (Optional)
var_controlled_access <-  # List[bool] | Filter by controlled_access (Optional)
...
var_file_set <-  # List[str] | Filter by file_set (Optional)
var_file_size <-  # List[int] | Filter by file_size (Optional)
var_flowcell_id <-  # List[str] | Filter by flowcell_id (Optional)
var_gene_list_for <-  # List[str] | Filter by gene_list_for (Optional)
var_href <-  # List[str] | Filter by href (Optional)
var_illumina_read_type <-  # List[str] | Filter by illumina_read_type (Optional)
var_index <-  # List[str] | Filter by index (Optional)
var_input_file_for <-  # List[str] | Filter by input_file_for (Optional)
var_integrated_in <-  # List[str] | Filter by integrated_in (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_lane <-  # List[int] | Filter by lane (Optional)
var_loci_list_for <-  # List[str] | Filter by loci_list_for (Optional)
var_maximum_read_length <-  # List[int] | Filter by maximum_read_length (Optional)
var_md5sum <-  # List[str] | Filter by md5sum (Optional)
var_mean_read_length <-  # List[float] | Filter by mean_read_length (Optional)
var_minimum_read_length <-  # List[int] | Filter by minimum_read_length (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_read_count <-  # List[int] | Filter by read_count (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_s3_uri <-  # List[str] | Filter by s3_uri (Optional)
var_seqspecs <-  # List[str] | Filter by seqspecs (Optional)
var_sequencing_kit <-  # List[str] | Filter by sequencing_kit (Optional)
var_sequencing_platform <-  # List[str] | Filter by sequencing_platform (Optional)
var_sequencing_run <-  # List[int] | Filter by sequencing_run (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_file_name <-  # List[str] | Filter by submitted_file_name (Optional)
 ...
 **sequencing_kit** | Enum [HiSeq SBS Kit v4, HiSeq SR Cluster Kit v4-cBot-HS, HiSeq PE Cluster Kit v4-cBot-HS, HiSeq SR Rapid Cluster Kit v2, HiSeq PE Rapid Cluster Kit v2, HiSeq Rapid SBS Kit v2, HiSeq 3000/4000 SBS Kit, HiSeq 3000/4000 SR Cluster Kit, HiSeq 3000/4000 PE Cluster Kit, MiSeq Reagent Kit v2, NextSeq 500 Mid Output Kit, NextSeq 500 High Output Kit, NextSeq 500 Mid Output v2 Kit, NextSeq 500 High Output v2 Kit, NextSeq 500/550 Mid-Output v2.5 Kit, NextSeq 500/550 High-Output v2.5 Kit, TG NextSeq 500/550 Mid-Output Kit v2.5, TG NextSeq 500/550 High-Output Kit v2.5, NextSeq 1000/2000 P1 Reagent Kit, NextSeq 1000/2000 P2 Reagent Kit, NextSeq 1000/2000 P3 Reagent Kit, NextSeq 1000/2000 P1 XLEAP-SBS Reagent Kit, NextSeq 1000/2000 P2 XLEAP-SBS Reagent Kit, NextSeq 2000 P3 XLEAP-SBS Reagent Kit, NextSeq 2000 P4 XLEAP-SBS Reagent Kit, NovaSeq 6000 SP Reagent Kit v1.5, NovaSeq 6000 S1 Reagent Kit v1.5, NovaSeq 6000 S2 Reagent Kit v1.5, NovaSeq 6000 S4 Reagent Kit v1.5, NovaSeq X Series 1.5B Reagent Kit, NovaSeq X Series 10B Reagent Kit, NovaSeq X Series 25B Reagent Kit, ONT Ligation Sequencing Kit V14, Sequel sequencing kit 3.0, Sequel II sequencing kit 2.0] | Filter by sequencing_kit | [optional] 
...
var_loci_list_for <-  # List[str] | Filter by loci_list_for (Optional)
var_md5sum <-  # List[str] | Filter by md5sum (Optional)
var_normalized <-  # List[bool] | Filter by normalized (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_reference_files <-  # List[str] | Filter by reference_files (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_s3_uri <-  # List[str] | Filter by s3_uri (Optional)
var_start_view_position <-  # List[str] | Filter by start_view_position (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_strand_specificity <-  # List[str] | Filter by strand_specificity (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitted_file_name <-  # List[str] | Filter by submitted_file_name (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
...
var_summary <-  # List[str] | Filter by summary (Optional)
var_title <-  # List[str] | Filter by title (Optional)
var_used_by <-  # List[str] | Filter by used_by (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_versions <-  # List[str] | Filter by versions (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$software(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, aliases = var_aliases, award_id = var_award_id, award_component = var_award_component, creation_timestamp = var_creation_timestamp, description = var_description, lab_id = var_lab_id, lab_title = var_lab_title, name = var_name, notes = var_notes, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, source_url = var_source_url, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, title = var_title, used_by = var_used_by, uuid = var_uuid, versions = var_versionsdata_file = "result.txt")
result <- api_instance$software(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, aliases = var_aliases, award_id = var_award_id, award_component = var_award_component, creation_timestamp = var_creation_timestamp, description = var_description, lab_id = var_lab_id, lab_title = var_lab_title, name = var_name, notes = var_notes, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, source_url = var_source_url, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, title = var_title, used_by = var_used_by, uuid = var_uuid, versions = var_versions)
dput(result)
```
...
# **software_versions**
> SoftwareVersionResults software_versions(frame, query = var.query, limit = var.limit, sort = var.sort, id = var.id, aliases = var.aliases, award_id = var.award_id, award_component = var.award_component, creation_timestamp = var.creation_timestamp, description = var.description, download_id = var.download_id, downloaded_url = var.downloaded_url, lab_id = var.lab_id, lab_title = var.lab_title, name = var.name, notes = var.notes, publications_id = var.publications_id, publications_publication_identifiers = var.publications_publication_identifiers, release_timestamp = var.release_timestamp, software_id = var.software_id, software_title = var.software_title, status = var.status, submitted_by_id = var.submitted_by_id, submitted_by_title = var.submitted_by_title, submitter_comment = var.submitter_comment, summary = var.summary, uuid = var.uuid, version = var.version)
...
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_download_id <-  # List[str] | Filter by download_id (Optional)
var_downloaded_url <-  # List[str] | Filter by downloaded_url (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_name <-  # List[str] | Filter by name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
...
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_software_id <-  # List[str] | Filter by software.@id (Optional)
var_software_title <-  # List[str] | Filter by software.title (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_version <-  # List[str] | Filter by version (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$software_versions(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, aliases = var_aliases, award_id = var_award_id, award_component = var_award_component, creation_timestamp = var_creation_timestamp, description = var_description, download_id = var_download_id, downloaded_url = var_downloaded_url, lab_id = var_lab_id, lab_title = var_lab_title, name = var_name, notes = var_notes, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, software_id = var_software_id, software_title = var_software_title, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, uuid = var_uuid, version = var_versiondata_file = "result.txt")
...
# **tabular_files**
> TabularFileResults tabular_files(frame, query = var.query, limit = var.limit, sort = var.sort, id = var.id, accession = var.accession, aliases = var.aliases, alternate_accessions = var.alternate_accessions, analysis_step_version = var.analysis_step_version, anvil_url = var.anvil_url, assembly = var.assembly, award_id = var.award_id, award_component = var.award_component, collections = var.collections, content_md5sum = var.content_md5sum, content_type = var.content_type, controlled_access = var.controlled_access, creation_timestamp = var.creation_timestamp, dbxrefs = var.dbxrefs, derived_from = var.derived_from, description = var.description, documents = var.documents, file_format = var.file_format, file_format_specifications = var.file_format_specifications, file_format_type = var.file_format_type, file_set = var.file_set, file_size = var.file_size, gene_list_for = var.gene_list_for, href = var.href, input_file_for = var.input_file_for, integrated_in = var.integrated_in, lab_id = var.lab_id, lab_title = var.lab_title, loci_list_for = var.loci_list_for, md5sum = var.md5sum, notes = var.notes, release_timestamp = var.release_timestamp, revoke_detail = var.revoke_detail, s3_uri = var.s3_uri, status = var.status, submitted_by_id = var.submitted_by_id, submitted_by_title = var.submitted_by_title, submitted_file_name = var.submitted_file_name, submitter_comment = var.submitter_comment, summary = var.summary, transcriptome_annotation = var.transcriptome_annotation, upload_status = var.upload_status, uuid = var.uuid, validation_error_detail = var.validation_error_detail)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$tabular_files(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, analysis_step_version = var_analysis_step_version, anvil_url = var_anvil_url, assembly = var_assembly, award_id = var_award_id, award_component = var_award_component, collections = var_collections, content_md5sum = var_content_md5sum, content_type = var_content_type, controlled_access = var_controlled_access, creation_timestamp = var_creation_timestamp, dbxrefs = var_dbxrefs, derived_from = var_derived_from, description = var_description, documents = var_documents, file_format = var_file_format, file_format_specifications = var_file_format_specifications, file_format_type = var_file_format_type, file_set = var_file_set, file_size = var_file_size, gene_list_for = var_gene_list_for, href = var_href, input_file_for = var_input_file_for, integrated_in = var_integrated_in, lab_id = var_lab_id, lab_title = var_lab_title, loci_list_for = var_loci_list_for, md5sum = var_md5sum, notes = var_notes, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, s3_uri = var_s3_uri, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitted_file_name = var_submitted_file_name, submitter_comment = var_submitter_comment, summary = var_summary, transcriptome_annotation = var_transcriptome_annotation, upload_status = var_upload_status, uuid = var_uuid, validation_error_detail = var_validation_error_detaildata_file = "result.txt")
result <- api_instance$tabular_files(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, analysis_step_version = var_analysis_step_version, anvil_url = var_anvil_url, assembly = var_assembly, award_id = var_award_id, award_component = var_award_component, collections = var_collections, content_md5sum = var_content_md5sum, content_type = var_content_type, controlled_access = var_controlled_access, creation_timestamp = var_creation_timestamp, dbxrefs = var_dbxrefs, derived_from = var_derived_from, description = var_description, documents = var_documents, file_format = var_file_format, file_format_specifications = var_file_format_specifications, file_format_type = var_file_format_type, file_set = var_file_set, file_size = var_file_size, gene_list_for = var_gene_list_for, href = var_href, input_file_for = var_input_file_for, integrated_in = var_integrated_in, lab_id = var_lab_id, lab_title = var_lab_title, loci_list_for = var_loci_list_for, md5sum = var_md5sum, notes = var_notes, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, s3_uri = var_s3_uri, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitted_file_name = var_submitted_file_name, submitter_comment = var_submitter_comment, summary = var_summary, transcriptome_annotation = var_transcriptome_annotation, upload_status = var_upload_status, uuid = var_uuid, validation_error_detail = var_validation_error_detail)
dput(result)
```
...
# **technical_samples**
> TechnicalSampleResults technical_samples(frame, query = var.query, limit = var.limit, sort = var.sort, id = var.id, accession = var.accession, aliases = var.aliases, alternate_accessions = var.alternate_accessions, award_id = var.award_id, award_component = var.award_component, classifications = var.classifications, collections = var.collections, construct_library_sets = var.construct_library_sets, creation_timestamp = var.creation_timestamp, date_obtained = var.date_obtained, dbxrefs = var.dbxrefs, description = var.description, documents = var.documents, file_sets_id = var.file_sets_id, file_sets_accession = var.file_sets_accession, file_sets_aliases = var.file_sets_aliases, file_sets_assay_term_term_name = var.file_sets_assay_term_term_name, file_sets_lab_title = var.file_sets_lab_title, file_sets_status = var.file_sets_status, file_sets_summary = var.file_sets_summary, institutional_certificates = var.institutional_certificates, lab_id = var.lab_id, lab_title = var.lab_title, lot_id = var.lot_id, moi = var.moi, multiplexed_in_id = var.multiplexed_in_id, multiplexed_in_accession = var.multiplexed_in_accession, notes = var.notes, nucleic_acid_delivery = var.nucleic_acid_delivery, origin_of = var.origin_of, product_id = var.product_id, protocols = var.protocols, publications_id = var.publications_id, publications_publication_identifiers = var.publications_publication_identifiers, release_timestamp = var.release_timestamp, revoke_detail = var.revoke_detail, sample_material = var.sample_material, sample_terms_id = var.sample_terms_id, sample_terms_term_name = var.sample_terms_term_name, sorted_fractions = var.sorted_fractions, sorted_from_id = var.sorted_from_id, sorted_from_accession = var.sorted_from_accession, sorted_from_detail = var.sorted_from_detail, sources_id = var.sources_id, starting_amount = var.starting_amount, starting_amount_units = var.starting_amount_units, status = var.status, submitted_by_id = var.submitted_by_id, submitted_by_title = var.submitted_by_title, submitter_comment = var.submitter_comment, summary = var.summary, taxa = var.taxa, time_post_library_delivery = var.time_post_library_delivery, time_post_library_delivery_units = var.time_post_library_delivery_units, url = var.url, uuid = var.uuid, virtual = var.virtual)
...
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_sample_material <-  # List[str] | Filter by sample_material (Optional)
var_sample_terms_id <-  # List[str] | Filter by sample_terms.@id (Optional)
var_sample_terms_term_name <-  # List[str] | Filter by sample_terms.term_name (Optional)
var_sorted_fractions <-  # List[str] | Filter by sorted_fractions (Optional)
var_sorted_from_id <-  # List[str] | Filter by sorted_from.@id (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$technical_samples(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, award_id = var_award_id, award_component = var_award_component, classifications = var_classifications, collections = var_collections, construct_library_sets = var_construct_library_sets, creation_timestamp = var_creation_timestamp, date_obtained = var_date_obtained, dbxrefs = var_dbxrefs, description = var_description, documents = var_documents, file_sets_id = var_file_sets_id, file_sets_accession = var_file_sets_accession, file_sets_aliases = var_file_sets_aliases, file_sets_assay_term_term_name = var_file_sets_assay_term_term_name, file_sets_lab_title = var_file_sets_lab_title, file_sets_status = var_file_sets_status, file_sets_summary = var_file_sets_summary, institutional_certificates = var_institutional_certificates, lab_id = var_lab_id, lab_title = var_lab_title, lot_id = var_lot_id, moi = var_moi, multiplexed_in_id = var_multiplexed_in_id, multiplexed_in_accession = var_multiplexed_in_accession, notes = var_notes, nucleic_acid_delivery = var_nucleic_acid_delivery, origin_of = var_origin_of, product_id = var_product_id, protocols = var_protocols, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, sample_material = var_sample_material, sample_terms_id = var_sample_terms_id, sample_terms_term_name = var_sample_terms_term_name, sorted_fractions = var_sorted_fractions, sorted_from_id = var_sorted_from_id, sorted_from_accession = var_sorted_from_accession, sorted_from_detail = var_sorted_from_detail, sources_id = var_sources_id, starting_amount = var_starting_amount, starting_amount_units = var_starting_amount_units, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, taxa = var_taxa, time_post_library_delivery = var_time_post_library_delivery, time_post_library_delivery_units = var_time_post_library_delivery_units, url = var_url, uuid = var_uuid, virtual = var_virtualdata_file = "result.txt")
result <- api_instance$technical_samples(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, award_id = var_award_id, award_component = var_award_component, classifications = var_classifications, collections = var_collections, construct_library_sets = var_construct_library_sets, creation_timestamp = var_creation_timestamp, date_obtained = var_date_obtained, dbxrefs = var_dbxrefs, description = var_description, documents = var_documents, file_sets_id = var_file_sets_id, file_sets_accession = var_file_sets_accession, file_sets_aliases = var_file_sets_aliases, file_sets_assay_term_term_name = var_file_sets_assay_term_term_name, file_sets_lab_title = var_file_sets_lab_title, file_sets_status = var_file_sets_status, file_sets_summary = var_file_sets_summary, institutional_certificates = var_institutional_certificates, lab_id = var_lab_id, lab_title = var_lab_title, lot_id = var_lot_id, moi = var_moi, multiplexed_in_id = var_multiplexed_in_id, multiplexed_in_accession = var_multiplexed_in_accession, notes = var_notes, nucleic_acid_delivery = var_nucleic_acid_delivery, origin_of = var_origin_of, product_id = var_product_id, protocols = var_protocols, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, sample_material = var_sample_material, sample_terms_id = var_sample_terms_id, sample_terms_term_name = var_sample_terms_term_name, sorted_fractions = var_sorted_fractions, sorted_from_id = var_sorted_from_id, sorted_from_accession = var_sorted_from_accession, sorted_from_detail = var_sorted_from_detail, sources_id = var_sources_id, starting_amount = var_starting_amount, starting_amount_units = var_starting_amount_units, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, taxa = var_taxa, time_post_library_delivery = var_time_post_library_delivery, time_post_library_delivery_units = var_time_post_library_delivery_units, url = var_url, uuid = var_uuid, virtual = var_virtual)
dput(result)
```
...
# **tissues**
> TissueResults tissues(frame, query = var.query, limit = var.limit, sort = var.sort, id = var.id, accession = var.accession, age = var.age, age_units = var.age_units, aliases = var.aliases, alternate_accessions = var.alternate_accessions, award_id = var.award_id, award_component = var.award_component, biomarkers = var.biomarkers, ccf_id = var.ccf_id, cellular_sub_pool = var.cellular_sub_pool, classifications = var.classifications, collections = var.collections, construct_library_sets = var.construct_library_sets, creation_timestamp = var.creation_timestamp, date_obtained = var.date_obtained, dbxrefs = var.dbxrefs, description = var.description, disease_terms_id = var.disease_terms_id, disease_terms_term_name = var.disease_terms_term_name, documents = var.documents, donors = var.donors, embryonic = var.embryonic, file_sets_id = var.file_sets_id, file_sets_accession = var.file_sets_accession, file_sets_aliases = var.file_sets_aliases, file_sets_assay_term_term_name = var.file_sets_assay_term_term_name, file_sets_lab_title = var.file_sets_lab_title, file_sets_status = var.file_sets_status, file_sets_summary = var.file_sets_summary, institutional_certificates_id = var.institutional_certificates_id, institutional_certificates_certificate_identifier = var.institutional_certificates_certificate_identifier, lab_id = var.lab_id, lab_title = var.lab_title, lot_id = var.lot_id, lower_bound_age = var.lower_bound_age, lower_bound_age_in_hours = var.lower_bound_age_in_hours, modifications_id = var.modifications_id, modifications_status = var.modifications_status, modifications_summary = var.modifications_summary, moi = var.moi, multiplexed_in_id = var.multiplexed_in_id, multiplexed_in_accession = var.multiplexed_in_accession, notes = var.notes, nucleic_acid_delivery = var.nucleic_acid_delivery, origin_of = var.origin_of, originated_from = var.originated_from, part_of = var.part_of, parts = var.parts, pmi = var.pmi, pmi_units = var.pmi_units, pooled_from = var.pooled_from, pooled_in = var.pooled_in, preservation_method = var.preservation_method, product_id = var.product_id, protocols = var.protocols, publications_id = var.publications_id, publications_publication_identifiers = var.publications_publication_identifiers, release_timestamp = var.release_timestamp, revoke_detail = var.revoke_detail, sample_terms_id = var.sample_terms_id, sample_terms_term_name = var.sample_terms_term_name, sex = var.sex, sorted_fractions = var.sorted_fractions, sorted_from_id = var.sorted_from_id, sorted_from_accession = var.sorted_from_accession, sorted_from_detail = var.sorted_from_detail, sources_id = var.sources_id, starting_amount = var.starting_amount, starting_amount_units = var.starting_amount_units, status = var.status, submitted_by_id = var.submitted_by_id, submitted_by_title = var.submitted_by_title, submitter_comment = var.submitter_comment, summary = var.summary, taxa = var.taxa, time_post_library_delivery = var.time_post_library_delivery, time_post_library_delivery_units = var.time_post_library_delivery_units, treatments_id = var.treatments_id, treatments_purpose = var.treatments_purpose, treatments_status = var.treatments_status, treatments_summary = var.treatments_summary, treatments_treatment_type = var.treatments_treatment_type, upper_bound_age = var.upper_bound_age, upper_bound_age_in_hours = var.upper_bound_age_in_hours, url = var.url, uuid = var.uuid, virtual = var.virtual)
...
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_biomarkers <-  # List[str] | Filter by biomarkers (Optional)
var_ccf_id <-  # List[str] | Filter by ccf_id (Optional)
var_cellular_sub_pool <-  # List[str] | Filter by cellular_sub_pool (Optional)
var_classifications <-  # List[str] | Filter by classifications (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_construct_library_sets <-  # List[str] | Filter by construct_library_sets (Optional)
...
var_part_of <-  # List[str] | Filter by part_of (Optional)
var_parts <-  # List[str] | Filter by parts (Optional)
var_pmi <-  # List[int] | Filter by pmi (Optional)
var_pmi_units <-  # List[str] | Filter by pmi_units (Optional)
var_pooled_from <-  # List[str] | Filter by pooled_from (Optional)
var_pooled_in <-  # List[str] | Filter by pooled_in (Optional)
var_preservation_method <-  # List[str] | Filter by preservation_method (Optional)
var_product_id <-  # List[str] | Filter by product_id (Optional)
var_protocols <-  # List[str] | Filter by protocols (Optional)
var_publications_id <-  # List[str] | Filter by publications.@id (Optional)
var_publications_publication_identifiers <-  # List[str] | Filter by publications.publication_identifiers (Optional)
...
var_id <-  # List[str] | Filter by @id (Optional)
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_amount <-  # List[float] | Filter by amount (Optional)
var_amount_units <-  # List[str] | Filter by amount_units (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_biosamples_treated <-  # List[str] | Filter by biosamples_treated (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_depletion <-  # List[bool] | Filter by depletion (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_documents <-  # List[str] | Filter by documents (Optional)
var_duration <-  # List[float] | Filter by duration (Optional)
var_duration_units <-  # List[str] | Filter by duration_units (Optional)
var_lab_id <-  # List[str] | Filter by lab.@id (Optional)
var_lab_title <-  # List[str] | Filter by lab.title (Optional)
var_lot_id <-  # List[str] | Filter by lot_id (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_p_h <-  # List[float] | Filter by pH (Optional)
var_post_treatment_time <-  # List[float] | Filter by post_treatment_time (Optional)
var_post_treatment_time_units <-  # List[str] | Filter by post_treatment_time_units (Optional)
var_product_id <-  # List[str] | Filter by product_id (Optional)
var_purpose <-  # List[str] | Filter by purpose (Optional)
var_release_timestamp <-  # List[str] | Filter by release_timestamp (Optional)
var_sources_id <-  # List[str] | Filter by sources.@id (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
...
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_temperature <-  # List[float] | Filter by temperature (Optional)
var_temperature_units <-  # List[str] | Filter by temperature_units (Optional)
var_treatment_term_id <-  # List[str] | Filter by treatment_term_id (Optional)
var_treatment_term_name <-  # List[str] | Filter by treatment_term_name (Optional)
var_treatment_type <-  # List[str] | Filter by treatment_type (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
...
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
var_description <-  # List[str] | Filter by description (Optional)
var_email <-  # List[str] | Filter by email (Optional)
var_first_name <-  # List[str] | Filter by first_name (Optional)
var_groups <-  # List[str] | Filter by groups (Optional)
var_job_title <-  # List[str] | Filter by job_title (Optional)
var_lab <-  # List[str] | Filter by lab (Optional)
var_last_name <-  # List[str] | Filter by last_name (Optional)
var_notes <-  # List[str] | Filter by notes (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submits_for <-  # List[str] | Filter by submits_for (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_title <-  # List[str] | Filter by title (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_viewing_groups <-  # List[str] | Filter by viewing_groups (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$whole_organisms(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, age = var_age, age_units = var_age_units, aliases = var_aliases, alternate_accessions = var_alternate_accessions, award_id = var_award_id, award_component = var_award_component, biomarkers = var_biomarkers, cellular_sub_pool = var_cellular_sub_pool, classifications = var_classifications, collections = var_collections, construct_library_sets = var_construct_library_sets, creation_timestamp = var_creation_timestamp, date_obtained = var_date_obtained, dbxrefs = var_dbxrefs, description = var_description, disease_terms_id = var_disease_terms_id, disease_terms_term_name = var_disease_terms_term_name, documents = var_documents, donors = var_donors, embryonic = var_embryonic, file_sets_id = var_file_sets_id, file_sets_accession = var_file_sets_accession, file_sets_aliases = var_file_sets_aliases, file_sets_assay_term_term_name = var_file_sets_assay_term_term_name, file_sets_lab_title = var_file_sets_lab_title, file_sets_status = var_file_sets_status, file_sets_summary = var_file_sets_summary, institutional_certificates_id = var_institutional_certificates_id, institutional_certificates_certificate_identifier = var_institutional_certificates_certificate_identifier, lab_id = var_lab_id, lab_title = var_lab_title, lot_id = var_lot_id, lower_bound_age = var_lower_bound_age, lower_bound_age_in_hours = var_lower_bound_age_in_hours, modifications_id = var_modifications_id, modifications_status = var_modifications_status, modifications_summary = var_modifications_summary, moi = var_moi, multiplexed_in_id = var_multiplexed_in_id, multiplexed_in_accession = var_multiplexed_in_accession, notes = var_notes, nucleic_acid_delivery = var_nucleic_acid_delivery, origin_of = var_origin_of, originated_from = var_originated_from, part_of = var_part_of, parts = var_parts, pooled_from = var_pooled_from, pooled_in = var_pooled_in, product_id = var_product_id, protocols = var_protocols, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, sample_terms_id = var_sample_terms_id, sample_terms_term_name = var_sample_terms_term_name, sex = var_sex, sorted_fractions = var_sorted_fractions, sorted_from_id = var_sorted_from_id, sorted_from_accession = var_sorted_from_accession, sorted_from_detail = var_sorted_from_detail, sources_id = var_sources_id, starting_amount = var_starting_amount, starting_amount_units = var_starting_amount_units, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, taxa = var_taxa, time_post_library_delivery = var_time_post_library_delivery, time_post_library_delivery_units = var_time_post_library_delivery_units, treatments_id = var_treatments_id, treatments_purpose = var_treatments_purpose, treatments_status = var_treatments_status, treatments_summary = var_treatments_summary, treatments_treatment_type = var_treatments_treatment_type, upper_bound_age = var_upper_bound_age, upper_bound_age_in_hours = var_upper_bound_age_in_hours, url = var_url, uuid = var_uuid, virtual = var_virtualdata_file = "result.txt")
result <- api_instance$whole_organisms(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, age = var_age, age_units = var_age_units, aliases = var_aliases, alternate_accessions = var_alternate_accessions, award_id = var_award_id, award_component = var_award_component, biomarkers = var_biomarkers, cellular_sub_pool = var_cellular_sub_pool, classifications = var_classifications, collections = var_collections, construct_library_sets = var_construct_library_sets, creation_timestamp = var_creation_timestamp, date_obtained = var_date_obtained, dbxrefs = var_dbxrefs, description = var_description, disease_terms_id = var_disease_terms_id, disease_terms_term_name = var_disease_terms_term_name, documents = var_documents, donors = var_donors, embryonic = var_embryonic, file_sets_id = var_file_sets_id, file_sets_accession = var_file_sets_accession, file_sets_aliases = var_file_sets_aliases, file_sets_assay_term_term_name = var_file_sets_assay_term_term_name, file_sets_lab_title = var_file_sets_lab_title, file_sets_status = var_file_sets_status, file_sets_summary = var_file_sets_summary, institutional_certificates_id = var_institutional_certificates_id, institutional_certificates_certificate_identifier = var_institutional_certificates_certificate_identifier, lab_id = var_lab_id, lab_title = var_lab_title, lot_id = var_lot_id, lower_bound_age = var_lower_bound_age, lower_bound_age_in_hours = var_lower_bound_age_in_hours, modifications_id = var_modifications_id, modifications_status = var_modifications_status, modifications_summary = var_modifications_summary, moi = var_moi, multiplexed_in_id = var_multiplexed_in_id, multiplexed_in_accession = var_multiplexed_in_accession, notes = var_notes, nucleic_acid_delivery = var_nucleic_acid_delivery, origin_of = var_origin_of, originated_from = var_originated_from, part_of = var_part_of, parts = var_parts, pooled_from = var_pooled_from, pooled_in = var_pooled_in, product_id = var_product_id, protocols = var_protocols, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, sample_terms_id = var_sample_terms_id, sample_terms_term_name = var_sample_terms_term_name, sex = var_sex, sorted_fractions = var_sorted_fractions, sorted_from_id = var_sorted_from_id, sorted_from_accession = var_sorted_from_accession, sorted_from_detail = var_sorted_from_detail, sources_id = var_sources_id, starting_amount = var_starting_amount, starting_amount_units = var_starting_amount_units, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, taxa = var_taxa, time_post_library_delivery = var_time_post_library_delivery, time_post_library_delivery_units = var_time_post_library_delivery_units, treatments_id = var_treatments_id, treatments_purpose = var_treatments_purpose, treatments_status = var_treatments_status, treatments_summary = var_treatments_summary, treatments_treatment_type = var_treatments_treatment_type, upper_bound_age = var_upper_bound_age, upper_bound_age_in_hours = var_upper_bound_age_in_hours, url = var_url, uuid = var_uuid, virtual = var_virtual)
dput(result)
```
...
var_aliases <-  # List[str] | Filter by aliases (Optional)
var_alternate_accessions <-  # List[str] | Filter by alternate_accessions (Optional)
var_analysis_steps <-  # List[str] | Filter by analysis_steps (Optional)
var_award_id <-  # List[str] | Filter by award.@id (Optional)
var_award_component <-  # List[str] | Filter by award.component (Optional)
var_collections <-  # List[str] | Filter by collections (Optional)
var_creation_timestamp <-  # List[str] | Filter by creation_timestamp (Optional)
...
var_revoke_detail <-  # List[str] | Filter by revoke_detail (Optional)
var_source_url <-  # List[str] | Filter by source_url (Optional)
var_standards_page_id <-  # List[str] | Filter by standards_page.@id (Optional)
var_standards_page_title <-  # List[str] | Filter by standards_page.title (Optional)
var_status <-  # List[str] | Filter by status (Optional)
var_submitted_by_id <-  # List[str] | Filter by submitted_by.@id (Optional)
var_submitted_by_title <-  # List[str] | Filter by submitted_by.title (Optional)
var_submitter_comment <-  # List[str] | Filter by submitter_comment (Optional)
var_summary <-  # List[str] | Filter by summary (Optional)
var_uuid <-  # List[str] | Filter by uuid (Optional)
var_workflow_repositories <-  # List[str] | Filter by workflow_repositories (Optional)
var_workflow_version <-  # List[int] | Filter by workflow_version (Optional)
...
api_instance$api_client$password <- Sys.getenv("PASSWORD")
# to save the result into a file, simply add the optional `data_file` parameter, e.g.
# result <- api_instance$workflows(var_frame, query = var_query, limit = var_limit, sort = var_sort, id = var_id, accession = var_accession, aliases = var_aliases, alternate_accessions = var_alternate_accessions, analysis_steps = var_analysis_steps, award_id = var_award_id, award_component = var_award_component, collections = var_collections, creation_timestamp = var_creation_timestamp, description = var_description, documents = var_documents, lab_id = var_lab_id, lab_title = var_lab_title, name = var_name, notes = var_notes, publications_id = var_publications_id, publications_publication_identifiers = var_publications_publication_identifiers, release_timestamp = var_release_timestamp, revoke_detail = var_revoke_detail, source_url = var_source_url, standards_page_id = var_standards_page_id, standards_page_title = var_standards_page_title, status = var_status, submitted_by_id = var_submitted_by_id, submitted_by_title = var_submitted_by_title, submitter_comment = var_submitter_comment, summary = var_summary, uuid = var_uuid, workflow_repositories = var_workflow_repositories, workflow_version = var_workflow_versiondata_file = "result.txt")
