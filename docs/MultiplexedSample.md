...
**construct_delivery_methods** | **set[character]** | The construct delivery methods of the samples included in this multiplexed sample. | [optional] 
...
**phenotypic_features** | **set[character]** | The phenotypic features of the samples included in this multiplexed sample. | [optional] 
